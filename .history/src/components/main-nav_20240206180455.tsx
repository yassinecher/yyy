...
export function MainNav({
  ...
  return (
    ...
    > 
     ...
     <NavigationMenu className="list-none bg-opacity-0">
            <NavigationMenuItem>
          <NavigationMenuTrigger className="bg-opacity-0 text-sm font-medium transition-colors hover:text-primary dark:text-white dark:hover:text-white dark:active:text-white">Peripherals</NavigationMenuTrigger>
          <NavigationMenuContent  className="bg-opacity-0 ">
          <ul className="grid bg-white bg-opacity-0  dark:bg-slate-950 grid-cols-1  min-w-[700px] ml-[380px] list-none gap-3 p-4  md:grid-cols-2 w-96 ">
