  ...
  return (
    <div className="price-filter-container mt-3" >
      ...
      <div className="grid grid-cols-2 mt-2">
        <div>
          <Label className="text-small">Min (en TND)</Label>
        ...
        <div>
          <Label className="text-small">Max (en TND)</Label>
          <div>
          <Input type="number" className=" mt-2 rounded-l-none "  value={value[1]} onChange={(e)=>{
            if(!Number.isNaN(parseInt(e.target.value))&&parseInt(e.target.value)>0){
              setLoading(true)
