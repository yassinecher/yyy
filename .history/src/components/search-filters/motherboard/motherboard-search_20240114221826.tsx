...
const SearchComponent: React.FC<SearchComponentProps>  = ({priceFilter,setPriceFilter,fetchData,searchTerm,setSearchTerm,setProducts,setLoading,setTotalPages,setCurrentPage,totalPages,currentPage}) => {
