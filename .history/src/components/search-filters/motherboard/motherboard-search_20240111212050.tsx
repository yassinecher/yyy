...
const SearchComponent: React.FC<SearchComponentProps>  = ({searchTerm,setSearchTerm,setProducts,setLoading,setTotalPages,setCurrentPage,totalPages,currentPage}) => {
