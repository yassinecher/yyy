...
const PriceFilter: React.FC<PriceFilterProps> = ({ handlePriceFilter, value }) => (
  ...
  <div className="price-filter-container">
   <Slider
      ...
      formatOptions={{style: "currency", currency: "TND",maximumFractionDigits:0}}
      classNames={{
        base: "max-w-md gap-3",
        filler: "bg-gradient-to-r from-neutral-300 to-orange-300 dark:from-neutral-600  dark:to-orange-800",
      }}
        ...
        >
          <span
            className={cn(
              ...
              index === 0
                ?"from-neutral-200 to-neutral-600 dark:from-neutral-600 dark:to-neutral-800"// first thumb
