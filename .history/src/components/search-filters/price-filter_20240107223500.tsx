...
const PriceFilter: React.FC<PriceFilterProps> = ({ handlePriceFilter, value }) => (
  ...
  <div className="price-filter-container">
   <Slider
      ...
      classNames={{
        base: "max-w-md gap-3",
        filler: "bg-gradient-to-r from-orange-300 to-slate-300 dark:from-orange-600 dark:to-slate-800",
      }}
        ...
        >
          <span
            className={cn(
              ...
              index === 0
                ? "from-orange-200 to-orange-500 dark:from-orange-400 dark:to-orange-600" // first thumb
                : "from-slate-200 to-slate-600 dark:from-slate-600 dark:to-slate-800", // second thumb
            )}
          />
        </div>
      )}
