  ...
  return (
    ...
    > 
     ...
     <NavigationMenu className="list-none">
          ...
          <NavigationMenuContent  className="dark:bg-slate-950 rounded-lg ml-[380px] ">
          <ul className="grid bg-white  dark:bg-slate-950 grid-cols-1  min-w-[700px] list-none gap-3 p-4  md:grid-cols-2 w-96 ">
