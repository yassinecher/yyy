 ...
 const HeaderNavigation: React.FC<HeaderProps>=({noscategy ,cathegories,links})=> {
  ...
  return (
    <NavigationMenu>
      ...
      <NavigationMenuItem>
          <NavigationMenuTrigger  className="focus:bg-transparent text-black dark:bg-transparent dark:text-black bg-transparent rounded-none hover:bg-transparent active:bg-transparent ">{li.label}
          </NavigationMenuTrigger>
