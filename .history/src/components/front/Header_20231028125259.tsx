...
<Button className='w-full mx-2 ' variant={'outline'} onClick={() => setOpen(!open)}>
          ...
          <div className="flex  items-center  content-around justify-between align-middle ali">
        
   

            <div className="m-5 text-xl font-bold relative logo-container flex  content-center">
