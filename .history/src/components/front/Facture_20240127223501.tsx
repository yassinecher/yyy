      ...
      <table className="table-auto border bg-white dark:bg-slate-950 dark:text-white border-black">
        <thead>
          <tr>
            ...
            <th className='border border-black p-3 '>Quantité</th>
            <th className='border border-black p-3'>Prix unitaire</th>
            <th className='border border-black dark:border-slate-500 p-3'>Total</th>
          </tr>
        </thead>
        <tbody>
