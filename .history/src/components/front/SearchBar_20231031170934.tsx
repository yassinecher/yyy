...
import { useRouter } from "next/router";   // Importing from the correct package
...
const SearchBar = () => {
    ...
    if (typeof searchQuery !== 'string') {
      ...
      return <div>No valid search query found.</div>;
    }
    ...
    const { data, error } = useSWR(
      ...
      fetchPosts,  // Make sure you have a function fetchPosts defined
