                ...
                <> {
                  "idd" in item ? <>
                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     <td className='px-6 py-4 font-black'>Pc par command</td>
                  ...
                  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     ...
                     <td className='px-6 py-4'>Carte Mére:{item.motherboard.name} </td>
                  ...
                  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     ...
                     <td className='px-6 py-4'>Processeur:{item.processor.name} </td>
                     <td className='px-6 py-4'>X1</td>
                  ...
                  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     ...
                     <td className='px-6 py-4'>Carte Grapfique:{item.gpu.name} </td>
                     <td className='px-6 py-4'>X1</td>
                  ...
                  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     ...
                     <td className='px-6 py-4'>Boitier:{item.case.name} </td>
                     <td className='px-6 py-4'>X1</td>
                  ...
                  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     ...
                     <td className='px-6 py-4'>Bloc d'alimentation:{item.power.name} </td>
                     <td className='px-6 py-4'>X1</td>
                  ...
                  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                     ...
                     <td className='px-6 py-4'>Stockage Principal:{item.disk.name} </td>
                     <td className='px-6 py-4'>X1</td>
                    ...
                    </tr>
                    {
                      ...
                      <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                         ...
                         <td className='px-6 py-4'>Stockage Secondaire:{item.disk2.name} </td>
                         <td className='px-6 py-4'>X1</td>
                    ...
                    }
                    {
                      ...
                      <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                         ...
                         <td className='px-6 py-4'>Refroidisseur CPU:{item.cooling.name} </td>
                         <td className='px-6 py-4'>X1</td>
                    ...
                    }
                    {
                      ...
                      <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600' >
                         ...
                         <td className='px-6 py-4'>Ecran:{item.screen.name} </td>
                         <td className='px-6 py-4'>X1</td>
