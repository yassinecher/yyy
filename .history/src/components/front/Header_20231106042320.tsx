...
const Header: React.FC<HeaderProps> = ({ session, cathegories, noscategy, links }) => {
  ...
  return (
    <>  <>
      ...
      <div className={` ${isMenuOpen ? 'flex' : 'hidden'} text-md fixed left-0 w-screen h-screen top-0  flex-col dark:bg-[#121212f5] bg-[#fffffff5] opacity-100 z-50`}>
        <div className=' overflow-y-auto overscroll-x-none overflow-x-clip pr-2 w-full'>
        ...
        <Button className='m-5 dark:bg-amber-500 dark:text-black bg-amber-400' variant={'default'}>
                  Build your pc
                </Button>
