        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="  ">
            <ul className="  dark:border-black  grid gap-3 md:w-[400px] rounded-none lg:w-[800px]  lg:grid-cols-3 ">
              ...
              <div className="col-span-2 grid grid-cols-2 m-5 dark:text-white ">
                {
                  catstodisplay.map((item)=>(<>
                       <ListItem className="hover:dark:bg-amber-100 hover:dark:text-black mx-2 mt-2 " href={`/shop?categorie=${item}`} title={item.toString()}>
