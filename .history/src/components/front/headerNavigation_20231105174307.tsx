      ...
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="  ">
            <ul className="  dark:border-black  grid gap-0 md:w-[400px] rounded-none lg:w-[800px]  lg:grid-cols-3 ">
              ...
              <div className="col-span-2 grid grid-cols-2 p-5 bg-white dark:bg-[#000000d6]  bg-opacity-75  dark:text-white ">
                {
