  ...
  return (
    <div>
      ...
      <CommandDialog  open={open} onOpenChange={setOpen}>
        <CommandInput onKeyUp={(e) =>{ router.push(`./?q=${e}`);console.log(searchQuery)}} placeholder="search..." className='border-0 outline-0 focus:outline-none focus:outline-0 focus:outline-transparent focus:border-0 focus:shadow-none ' />
        <CommandList   >
