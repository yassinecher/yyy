    ...
    <NavigationMenu>
      ...
      <NavigationMenuItem>
          ...
          <NavigationMenuContent className="  ">
            <ul className={`"${catstodisplay.length>0?' grid lg:grid-cols-3 lg:w-[800px]':' grid lg:grid-cols-1 lg:w-[300px]'} custom-nav  dark:border-black  gap-0 md:w-[400px] rounded-none   "`}>
