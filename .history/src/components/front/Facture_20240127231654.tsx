...
const Invoice = (props: { invoiceData: CartItem[] }) => {
  return (
    <div className='container bg-white py-5 rounded-lg my-5'>
      <h1 className='text-2xl font-bold'>Facture</h1>
      <div className=' my-3 border-gray-200 relative overflow-x-auto shadow-md sm:rounded-lg tt '>
        <table className="border w-full text-md text-left sm:rounded-t-lg rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className=' sm:rounded-lg text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400'>
          <tr className='sm:rounded-lg border-b text-lg'>
                    
              <th  scope="col" className="px-6 py-3 sm:rounded-lg" >Nom de produit</th>
