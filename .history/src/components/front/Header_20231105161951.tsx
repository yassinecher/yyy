      ...
      <div >
        <div className=" flex items-center align-middle  h-[56px] max-lg:hidden justify-center">
         <div className=" tr-left border-r-orange-50 ">
          ...
          <div className=" tr-right border-0 bg-orange-50 text-orange-50 ">

       
        <svg id="triangle" fill='currentColor' viewBox="0 0 100 100">
            	<polygon points="100 0 0 0 0 100" fill='currentColor'/>
        </svg>
