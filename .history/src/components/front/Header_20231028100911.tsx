...
const Header: React.FC<HeaderProps> = ({ session, cathegories }) => {
  ...
  return (
    ...
    {session?.user.role === "admin" ? (  <Link href={"/admin"}>
      ...
      <div className="">
        <div className="flex  items-center px-4  content-between justify-around">
  ...
  <div className="bg-slate-100 image-container wave__btn flex align-middle content-center justify-center items-center">
              <div className=" rounded-full">
                <img
                  src="/images/logo (3).png"
                  className=" w-full p-2  max-md:w-12 max-md:h-12  rounded-full max-w-full"
                  alt=""
                />
              </div>
            </div>
