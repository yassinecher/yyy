          ...
          {linkMobile.map((linkk) => (<>
            {linkk.link.length > 0 ? <>
              ...
              <Link onClick={() => setIsMenuOpen(!isMenuOpen)}  href={'' + linkk.link}>  
                  <Button  
                  className="mx-3 list-none bg-[#ccc1df] dark:border-0 dark:bg-[#5d3c96] dark:text-white text-black w-full bg-opacity-50 rounded-sm text-center border-1 border-[#673AB7] my-2 py-2 " >
