...
const Header: React.FC<HeaderProps> = ({ session, cathegories, noscategy, links }) => {
  ...
  return (
    <>  <>
      ...
      <div className={` ${isMenuOpen ? 'flex' : 'hidden'} text-md fixed left-0 w-full min-h-screen top-0  overflow-y-auto flex-col dark:bg-black bg-[#fffffff5] opacity-100 z-50`}>
                      ...
                      <AccordionContent>
                        {
                          noscategy[key].CathegoryCollectiondata.map((i)=>(<>
                           <NavigationMenuItem className="mx-14 list-none">
