...
const Invoice = (props: { invoiceData: CartItem[] ,order:Order|null}) => {
  ...
  return (
    <div ref={invoiceRef} id=''  className='container bg-white dark:bg-slate-950 py-5 rounded-lg my-5'>
      <div>   <h1 className='text-3xl font-bold text-amber-500 dark:text-amber-400'>Facture</h1>
