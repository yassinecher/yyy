        ...
        <button className='bg-red-500 w-full text-white '>Admin Panel</button></Link>) : <></>}
          ...
          <div className='w-full p-3 hidden max-sm:flex'>
            ...
            <Button className='ml-2 p-2' variant={'outline'} onClick={() => setIsMenuOpen(!isMenuOpen)}>
              <svg fill="currentColor" height="20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16a1 1 0 0 1 0 2H4a1 1 0 1 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2z"/></svg>
            </Button>
          </div>
        </div>
