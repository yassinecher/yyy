                      ...
                      <AccordionContent>
                        {
                          noscategy[key].CathegoryCollectiondata.map((i)=>(<>
                           <NavigationMenuItem className="w-full  mr-7 list-none">
                  
                <Button
                  className=" list-none bg-orange-50 text-black w-full bg-opacity-50 rounded-sm text-center border-1 border-orange-100 m-3 mr-7 py-2 dark:text-black " >
