...
{each.DeletedPrice.length > 0 ? (
  <p className='py-7' style={{ color: each.DeletedPriceColor.length > 0 ? each.DeletedPriceColor : '' }}>
    {each.DeletedPrice} TND
  </p>
) : null}
{each.Price.length > 0 ? (
  <p className='py-7' style={{ color: each.PriceColor.length > 0 ? each.PriceColor : '' }}>
    {each.Price} TND
  </p>
) : null}
