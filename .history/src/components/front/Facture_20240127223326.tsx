      ...
      <table className="table-auto border border-black">
        <thead>
          <tr>
            ...
            <th className='border border-black '>Quantité</th>
            <th className='border border-black '>Prix unitaire</th>
            <th className='border border-black dark:border-slate-500'>Total</th>
          </tr>
        </thead>
        <tbody>
