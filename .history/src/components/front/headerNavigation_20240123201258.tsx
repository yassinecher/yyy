 ...
 const HeaderNavigation: React.FC<HeaderProps>=({noscategy ,cathegories,links})=> {
  ...
  <NavigationMenu.Root className="NavigationMenuRoot flex">
    ...
    {links.map((linkk ,key)=>(<>
      ...
      <NavigationMenu.Item>
          <NavigationMenu.Trigger   className="focus:bg-transparent custom-nav text-black dark:bg-transparent dark:text-black bg-transparent rounded-none hover:bg-transparent active:bg-transparent " onMouseMoveCapture={()=>{
