...
<Button className='w-full mx-0 ' variant={'outline'} onClick={() => setOpen(!open)}>
  ...
  <svg fill="#ffffff" height="20" width="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 297 297">
<g>
	<g>
		<g>
...
<div  className={` ${isMenuOpen ? 'flex' : 'hidden'} absolute top-0 left-0 w-full h-full bg-black opacity-90 z-50`}>
  <div  className='flex float-right'>
    <Button className='m-3 ml-auto right-0' variant={'ghost'}>
