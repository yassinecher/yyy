...
const Slideshow : React.FC<SlideshowProps> = ({slides} ) => {
    ...
    return (
        <Card className=' my-10 border-0 p-0   max-sm:h-auto max-sm:mb-2 bg-orange-50 dark:bg-black  opacity-90  max-sm:rounded-none  '>
  
  <CardContent className='p-0 m-0'>
 
        <Zoom cssClass='card'  scale={1.4}  duration={5000} infinite canSwipe={true} indicators={true}
