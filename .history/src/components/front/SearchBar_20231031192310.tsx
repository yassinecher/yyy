  ...
  return (
    <div>
      ...
      <CommandDialog  open={open} onOpenChange={setOpen}>
        <CommandInput onValueChange={(e) => router.push(`/search?q=${e}`)} placeholder="search..." className='border-0 outline-0 focus:outline-none focus:outline-0 focus:outline-transparent focus:border-0 focus:shadow-none ' />
        <CommandList   >
