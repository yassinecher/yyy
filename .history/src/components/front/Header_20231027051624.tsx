          ...
          <div className="md:flex justify-between">
            ...
            <div className="lg:ml-6 flex flex-1 ">
              ...
              <div className='block2 w-full m-auto   lg:ml-6 flex flex-1'>
                <div className="flex cursor-pointer select-none items-center  align-middle  max-md:hidden cat  bg-transparent  px-4  hover:bg-[#f0f0f0]">
              ...
              >
                <div className="text-sm lg:flex-grow">
                  <a
                    ...
                    className="block mt-4 lg:inline-block lg:mt-0 text-yellow-100 hover: mr-4"
                  >
                    Docs
                  </a>
                  <a
                  ...
                  <a
                    href="#responsive-header"
                    className="block mt-4 lg:inline-block lg:mt-0 text-yellow-100 hover:"
                  >
                    Blog
                  </a>
                </div>
