...
const Header: React.FC<HeaderProps> = ({ session, cathegories }) => {
  ...
  return (
    ...
    {session?.user.role === "admin" ? (  <Link href={"/admin"}>
      ...
      <div className="">
        <div className="grid grid-cols-3  items-center  content-around justify-between">
...
<Button className='w-full mx-2 ' variant={'outline'} onClick={() => setOpen(!open)}>
          ...
          <div className="flex  items-center  content-around w-full   align-middle">
        
   

            <div className="m-5 w-full text-xl font-bold relative logo-container flex  content-center items-center align-middle">
