...
const ProductCard: React.FC<ProductCard> = ({
  ...
  return ( 
    <div onClick={handleClick} className="dark:bg-[#00000000] bg-[#ffffff31]  group cursor-pointer dark:border-indigo-100 rounded-xl border p-3 ">
      {/* Image & actions */}
    ...
    <Image src={'/images/remise-dark.png'} className="invisible dark:visible absolute  z-20 -mr-3 -mt-3 rotate-[25deg] ml-auto" alt="" width={70} height={70} />
     ...
     <div className="aspect-square rounded-xl flex bg-gray-100 dark:bg-transparent  relative">
      ...
      {/* Price & Reiew */}
      <div className="flex items-center flex-col text-center  space-y-0 text-lg  my-2 mt-auto  text-[#673ab6]">
