...
const Editorr = () => {
  ...
  useEffect(() => {
    ...
    const handleDocumentPaste = (e: { target?: any; preventDefault?: () => void; clipboardData?: any; originalEvent?: { clipboardData: any; }; }) => {
      if (e.target.closest('.public-DraftEditor-content')) {
        // The paste event occurred within the editor's content area
        handlePasteImage(e.target);
      }
    };
