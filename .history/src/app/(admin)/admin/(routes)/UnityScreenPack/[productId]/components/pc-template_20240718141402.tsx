...
interface ProductFormProps {
  ...
  setDefaultPackPad: (ProdCol: String) => void
  ...
  return (
    <>
      <div>   <div className='font-semibold'>Unity</div>
        <MotherboardCOl init={UnityList} MotherBoardId={DefaultUnity} setMotherBoardId={setDefaultUnity} lastMotherBoardId={LastmotherboardId} colname="mb" motherboards={keyboards} updateList={(e) => setUnityList(e)} selectionStaue={selectionStatu} onSlectionChange={(e) => setSelectionStatu(e)} />
      </div>
      <div>
      ...
      <div>
        ...
        <MotherboardCOl init={PackList} MotherBoardId={DefaultPack} setMotherBoardId={setDefaultPack} lastMotherBoardId={LastmotherboardId} colname="cpu" motherboards={Mouses} updateList={(e) => setPackList(e)} selectionStaue={selectionStatu} onSlectionChange={(e) => setSelectionStatu(e)} />
      </div>
