...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData  && initialData.motherboard ? {
    ...
    cpusupportId:initialData.motherboard[0].chipsetId,
    cpusupportId:initialData.motherboard[0].formatId,
    cpusupportId:initialData.motherboard[0].manufacturerId,
    cpusupportId:initialData.motherboard[0].ramslotsId
  } : {
    name: '',
    images: [],
    price: 0,
