...
console.log(initialData)
  ...
  const form2 = useForm<ProductFormValues>({
              ...
              <FormItem  >
                ...
                <div className="md:grid md:grid-cols-2 align-middle items-center gap-8">
                  ...
                  <div className="">
                    ...
                    <Button type="button" variant={"outline"} onClick={openDialog}>Add Ram Slot</Button>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input disabled={loading} type="number" placeholder="Number" {...field} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                              <FormItem>
