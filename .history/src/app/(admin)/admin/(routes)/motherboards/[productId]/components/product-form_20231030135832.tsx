...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData  && initialData.motherboard ? {
    ...initialData,
...
console.log(initialData)
  ...
  const submit1 = async () => {
    ...
    if (!form2.formState.dirtyFields) {
      try {
        const name = form2.getValues().manifacturername
        setLoading(true);

        await axios.post(`/api/motherboard/ramslots`, { name, imageUrl: "" });
  ...
  const closeDialog = async () => {
    ...
    if (form.getValues().manifacturername) {
      try {
        ...
        await axios.post(`/api/motherboard//api/motherboard/RamSlots`, { name, imageUrl: "" });
...
<FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea disabled={loading} placeholder="Product name" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormItem  >
                ...
                <div className="md:grid md:grid-cols-2 align-middle items-center gap-8">
                  ...
                  <div className="">
                    ...
                    <Button type="button" variant={"outline"} onClick={openDialog2}>Add Ram Slot</Button>
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                      <Form {...form2}>
                        <form onSubmit={form2.handleSubmit(submit1)} >
                        <DialogHeader >
                        ...
                        <DialogFooter className="sm:justify-end">
                          ...
                          <Button onClick={submit1} type="button" variant="secondary">
                            save
                          </Button>
