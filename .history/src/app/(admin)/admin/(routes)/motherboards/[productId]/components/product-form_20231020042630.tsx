...
const formSchema = z.object({
  ...
  CPUSupportID:z.string().optional(),
              ...
              <FormItem  >
                ...
                <div className="md:grid md:grid-cols-2 align-middle items-center gap-8">
                  ...
                  <div className="">
                    ...
                    <Button type="button"  className="w-full" variant={"outline"} onClick={openDialog1}>Add Ram Slots</Button>
...
<PopFormModal label={"Motherboard Chipset"} 
          ...
          <PopFormModal label={"CPU Support"} 
              ...
              formCControlName="cpusupportId"
              />
          
          <PopFormModal label={"Guarantee"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...cpusupport}
