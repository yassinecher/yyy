                ...
                <div>
                  <Select disabled={loading} onValueChange={ field.onChange } value={field.value ? String(field.value) : ''} defaultValue={field.value ? String(field.value) : ''}>
                    ...
                    <SelectContent>
                     ...
                     {category.TypeOf[fieldaAfficher as keyof typeof category.TypeOf]}
                   </SelectItem>    ))}
                    </SelectContent>
                  </Select>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                              <Input disabled={loading} type="number" value={field.value ? String(field.value) : ''} onChange={field.onChange} />
