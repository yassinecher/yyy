...
import { Category, Image, Product, Manufacturer, RamSlots, MotherboardChipset, CPUSupport, Guarantee, MotherboardFormat, MemoryMarque, MemoryNumber, MemoryType, MemoryFrequency, Memory, GraphiccardName, GpuArchBrand, GpuBrand, Gpu, PowersupplyMarque, Certification80, Powersupply } from "@prisma/client"
...
const formSchema = z.object({
  ...
  Powerinwatt: z.coerce.number().min(1),
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData ? {
    ...
    certification80ID:  initialData.powersupplies[0].certification80ID,
    powersupplyMarqueID:  initialData.powersupplies[0].powersupplyMarqueID,

    
    Power:parseFloat(String(initialData?.dicountPrice)),
