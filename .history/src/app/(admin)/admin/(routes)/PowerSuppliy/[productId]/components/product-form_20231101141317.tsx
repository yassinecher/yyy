...
import { Category, Image, Product, Manufacturer, RamSlots, MotherboardChipset, CPUSupport, Guarantee, MotherboardFormat, MemoryMarque, MemoryNumber, MemoryType, MemoryFrequency, Memory, GraphiccardName, GpuArchBrand, GpuBrand, Gpu, PowersupplyMarque, Certification80 } from "@prisma/client"
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData ? {
    ...
    GpuBrandId:  initialData.gpus[0].GpuBrandId,
    gpuArchBrandId:  initialData.gpus[0].gpuArchBrandId,
    graphiccardNameId: initialData.gpus[0].graphiccardNameId,
