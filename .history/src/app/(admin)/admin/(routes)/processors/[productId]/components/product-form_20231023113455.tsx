...
import { Category, Image, Product, Manufacturer, RamSlots, MotherboardChipset, CPUSupport, Guarantee, MotherboardFormat, ProcessorModel } from "@prisma/client"
...
<PopFormModal label={"CPU Support"} 
              ...
              formCControlName="supportduprocesseurId"
              IsNumber={false}
              />
