...
<PopFormModal label={"HarddiskBrand"} 
              form1={form} 
              loading={loading} 
              ...
              formLab="brandId"
              formCControlName="HarddiskBrand"
              IsNumber={false}
              />

         
<PopFormModal label={"HarddiskComputerinterface"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...HarddiskComputerinterface}
              fieldaAfficher="name"
              url="/api/harddisk/GpuArchBrand"
              formLab="ComputerinterfaceId"
              formCControlName="HarddiskComputerinterface"
              IsNumber={false}
              />
          
          <PopFormModal label={"HarddiskCapacityId"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...HarddiskCapacity}
              fieldaAfficher="name"
              url="/api/harddisk/GraphiccardName"
              formLab="DiscFormatId"
              formCControlName="GraphiccardName"
              IsNumber={false}
              />
          <PopFormModal label={"HarddiskCapacity"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...HarddiskCapacity}
              fieldaAfficher="name"
              url="/api/harddisk/GpuBrand"
              formLab="capacityId"
              formCControlName="HarddiskCapacity"
              IsNumber={false}
              />
