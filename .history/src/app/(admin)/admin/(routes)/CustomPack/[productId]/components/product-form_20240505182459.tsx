...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const [keyboardList,setkeyboardList]=useState<ProdCol[]>(keyboards.filter((e)=>initialData?.PackProduct?.Clavier.find((ee)=>e.id==ee.id)))
  const [MouseList,setMouseList]=useState<ProdCol[]>(Mouses.filter((e)=>initialData?.PackProduct?.Mouse.find((ee)=>e.id==ee.id)))
  const [MousepadsList,setMousepadsList]=useState<ProdCol[]>(Mousepads.filter((e)=>initialData?.PackProduct?.MousePad.find((ee)=>e.id==ee.id)))
  const [MicsList,setMicsList]=useState<ProdCol[]>(Mics.filter((e)=>initialData?.PackProduct?.Mic.find((ee)=>e.id==ee.id)))
  const [HeadsetsList,setHeadsetsList]=useState<ProdCol[]>(Headsets.filter((e)=>initialData?.PackProduct?.Headset.find((ee)=>e.id==ee.id)))
  const [CamerasList,setCamerasList]=useState<ProdCol[]>(Cameras.filter((e)=>initialData?.PackProduct?.Camera.find((ee)=>e.id==ee.id)))
  const [screensList,setscreensList]=useState<ProdCol[]>(screens.filter((e)=>initialData?.PackProduct?.Screen.find((ee)=>e.id==ee.id)))
  const [HautparleursList,setHautparleursList]=useState<ProdCol[]>(Hautparleurs.filter((e)=>initialData?.PackProduct?.Speaker.find((ee)=>e.id==ee.id)))
  const [ManettesList,setManettesList]=useState<ProdCol[]>(Manettes.filter((e)=>initialData?.PackProduct?.Manette.find((ee)=>e.id==ee.id)))
  const [ChaisegamingsList,setChaisegamingsList]=useState<ProdCol[]>(Chaisegamings.filter((e)=>initialData?.PackProduct?.Chair.find((ee)=>e.id==ee.id)))  
