...
import { Category, Image, Product, Manufacturer, RamSlots, MotherboardChipset, CPUSupport, Guarantee, MotherboardFormat, MemoryMarque, MemoryNumber, MemoryType, MemoryFrequency, Memory, PCcase, PCcaseBrand, PCcaseCaseformat, PCcaseNumberofFansPreinstalled, PCcaseRGBType, Field } from "@prisma/client"
...
export const ProductForm: React.FC<ProductFormProps> = ({
  initialData,
  categories, pCcaseBrand, pCcaseCaseformat, pCcaseNumberofFansPreinstalled, pCcaseRGBType
}) => {
  ...
  const defaultValues = initialData ? {
    ...
    brandId:  initialData.cases[0].brandId,
    caseformatiD:  initialData.cases[0].caseformatiD,
    numberofFansPreinstalledId: initialData.cases[0].numberofFansPreinstalledId,
    rGBTypeId:  initialData.cases[0].rGBTypeId,
...
<PopFormModal label={"Case format"} 
          ...
          <PopFormModal label={"Number of Preinstalled Fans"} 
              ...
              formCControlName="pCcaseNumberofFansPreinstalled"
              IsNumber={false}
              /> 
          
          <PopFormModal label={"Case RGB Type"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...pCcaseRGBType}
              ...
              formLab="rGBTypeId"
              formCControlName="pCcaseRGBType"
              IsNumber={false}
              />
