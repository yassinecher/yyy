...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData ? {
    ...
    RefreshRateId:  initialData.screens[0].RefreshRateId,
    resolutionId:  initialData.screens[0].resolutionId,
  ...
  const onSubmit = async (data: ProductFormValues) => {
    ...
    try {
      ...
      if (initialData) {
        await axios.patch(`/api/Screen/component/${params.productId}`, data);
      } else {
        await axios.post(`/api/Screen/component`, data);
      }
      router.refresh();
      ...
      <Form {...form}>
        ...
        <FormField
          ...
          <PopFormModal label={"Pouce"} 
              ...
              formLab="PouceId"
              formCControlName="Pouce"
              IsNumber={false}
              />
          
          <PopFormModal label={"Resolution"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...resolution}
              ...
              formCControlName="Resolution"
              IsNumber={false}
              />

<PopFormModal label={"RefreshRate in hz"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...refreshRate}
              ...
              formCControlName="RefreshRate in hz"
              IsNumber={false}
              />
