...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData  && initialData.Mic ? {
    ...
    keyboarbrandId:initialData.Mic[0].micModelId??'',
    keyboarFormatId:initialData.Mic[0].micInterfaceAvecOrdinateurId??'',
    keyboarButtonsNumberId:initialData.Mic[0].micSonSurroundId??'',
