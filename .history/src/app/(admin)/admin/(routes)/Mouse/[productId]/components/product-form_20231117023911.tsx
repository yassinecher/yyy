...
import { Category, Image, Product, Manufacturer, RamSlots, MotherboardChipset, CPUSupport, Guarantee, MotherboardFormat, Motherboard, Field, Laptop, LapRefreshRate, LapCamera, LapSound, Lapnetwork, Lapmemory, LapHardisk, LapScreenType, LapScreenSize, LapGraphiccardRef, LapGraphiccard, LapProcesseurRe, LapProcesseur, LapSystem, keyboard, keyboarButtonsNumber, keyboarFormat, keyboarTouchType, keyboarbrand, Mousepad, Mouse } from "@prisma/client"
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const defaultValues = initialData  && initialData.Mouse ? {
    ...initialData,
    price: parseFloat(String(initialData?.price)),
    dicountPrice: parseFloat(String(initialData?.dicountPrice)),
    stock: parseFloat(String(initialData?.stock)),
   
    sensorTypeId:initialData.Mouse[0].sensorTypeId??'',
    wirless:initialData.Mouse[0].wirless??false,
    rgb:initialData.Mouse[0].rgb??false,
    manufacturerId:initialData.Mouse[0].manufacturerId??'',
    ...
    <>
      ...
      <Form {...form}>
        ...
        <FormField
          ...
          <PopFormModal label={"Sensor Type"} 
              form1={form} 
              loading={loading} 
              setLoading={setLoading} 
              data={...MousepadModel}
              fieldaAfficher="name"
              url="/api/Mouse/SensorType"
              formLab="sensorTypeId"
              formCControlName="sensorType"
              IsNumber={false}
              />
