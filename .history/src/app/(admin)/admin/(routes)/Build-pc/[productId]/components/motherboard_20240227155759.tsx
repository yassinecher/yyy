              ...
              <div className='w-full pb-3 group '>
                {
                 ...
                 {MotherBoardId!= item.id?<>
                  <Button variant='bordered'  className='w-full bg-green-500' onClick={()=>setMotherBoardId(item.id)}> Set Default</Button>
                 </>:<>
                 <Button variant='bordered'  className='w-full bg-danger-500' >Default</Button>
