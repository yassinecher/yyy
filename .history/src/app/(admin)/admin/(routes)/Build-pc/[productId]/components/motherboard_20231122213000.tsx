...
const ProductCOl: React.FC<motherboardpar> = ({init,colname,motherboards,selectionStaue, setMotherBoardId,onSlectionChange,updateList,MotherBoardId,setLastMotherBoardId}) => {
