  ...
  return (
     <>
         <div>   <div className='font-semibold'>Motherboard</div>
           <MotherboardCOl init={mb} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId}  colname="mb" motherboards={motherboards}  updateList={(e)=>setMbs(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
    </div>
