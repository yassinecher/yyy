              ...
              <div className='w-full pb-3 group '>
                {
                 ...
                 {MotherBoardId!= item.id?<>
                  <button className='w-auto bg-green-500 m-2  text-white p-2 rounded-sm' onClick={()=>setMotherBoardId(item.id)}> Set Default</button>
                 </>:<>
                 <button   className='w-auto bg-red-500 m-2 text-white  p-2 rounded-sm' >Default</button>
