...
const [motherboardId,setMotherBoardId]=useState("")
  ...
  return (
    ...
    <div>pc-template
           ...
           <ProductCOl init={power} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId}  colname="cpu" motherboards={powersupplies}  updateList={(e)=>setPower(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
