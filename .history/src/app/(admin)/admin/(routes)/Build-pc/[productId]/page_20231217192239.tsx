...
const data={
  ...
  CPU: [product?.PreBuiltPcmodel?.pcTemplate.caseId],

  GPU: [product?.PreBuiltPcmodel?.pcTemplate.caseId],
  motherboard: [product?.PreBuiltPcmodel?.pcTemplate.caseId],
  powersupply: [product?.PreBuiltPcmodel?.pcTemplate.caseId],
  RAM:  [product?.PreBuiltPcmodel?.pcTemplate.caseId];
  disk: [product?.PreBuiltPcmodel?.pcTemplate.caseId],
}
  return ( 
