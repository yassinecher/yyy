    ...
    <div className='mt-0'>
           ...
           
        {
           ...
           {motherboardList.map((item)=>{
                return (
                    <><div className={'flex flex-col justify-between  bg-slate-100 rounded-lg  text-slate-800  dark:bg-slate-800 dark:text-slate-100 '+(localselectionStaue==true?'':'dark:bg-slate-700 bg-slate-200')}>
