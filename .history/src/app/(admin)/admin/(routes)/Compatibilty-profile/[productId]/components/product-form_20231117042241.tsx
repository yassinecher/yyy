...
const [motherboardId,setMotherBoardId]=useState("")
 ...
 <div>
          ...
          <div>
            ...
            <MotherboardCOl lastMotherBoardId={motherboardId} setLastMotherBoardId={(e)=>setMotherBoardId(e.toString())} colname="mb" motherboards={motherboards} updateList={(e)=>setMbs(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
