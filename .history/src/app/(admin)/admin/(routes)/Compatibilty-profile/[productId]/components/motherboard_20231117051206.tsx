...
const ProductCOl: React.FC<motherboardpar> = ({colname,motherboards,selectionStaue, setMotherBoardId,onSlectionChange,updateList,MotherBoardId,lastMotherBoardId,setLastMotherBoardId}) => {
...
switch (dayOfWeek) {
 ...
 const removeItem = (itemToRemove:string) => {
    ...
    if(colname=="mb"&&motherboardList.length===0){
