           ...
           
        {
           ...
           {motherboardList.map((item)=>{
                return (
                    ...
                    <div className='w-full pb-3 group cursor-pointer'>
                       {
...
<div className="aspect-square rounded-xl bg-gray-100 relative">
        ...
        <div className="opacity-0 group-hover:opacity-100 transition absolute w-full px-6 bottom-5">
          <div className="flex gap-x-6 justify-center">
            ...
            />
             <svg xmlns="http://www.w3.org/2000/svg"  fill='black' version="1.1" id="Layer_1" x="0px" y="0px" width="52px" height="52px" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
<g>
