...
switch (dayOfWeek) {
  ...
  return (
    <div className='mt-0'>
        ...
        <div className=' mt-1 mx-0  border-1 border-slate-200  dark:border-slate-800 rounded-lg '>
           
        {
           ...
           {motherboardList.map((item)=>{
                return (
                    <><div className={'flex flex-col justify-between  bg-slate-100 rounded-lg  text-slate-800  dark:bg-slate-800 dark:text-slate-100 '+(localselectionStaue==true?'':'dark:bg-slate-600 bg-slate-200')}>
