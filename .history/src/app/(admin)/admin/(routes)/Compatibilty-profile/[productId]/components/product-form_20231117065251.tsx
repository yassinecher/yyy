...
interface ProductFormProps {
  initialData: CompatibiltyProfile & {
    ...
    RAMs:ComponentOnPcGroupe[],
    disks:ComponentOnPcGroupe[],
  } | null;
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  console.log(motherboards.filter((e)=>initialData?.motherboards.find((ee)=>e.id==ee.productId)))
...
const [motherboardId,setMotherBoardId]=useState("")
 ...
 <div>
          ...
          <div>
            ...
            <MotherboardCOl init={mbs} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId} colname="cpu" motherboards={cpus}  updateList={(e)=>setcpu(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />

          </div>

          <div>
            <div className='font-semibold'>Graphic card</div>
            <MotherboardCOl init={mbs} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId}  colname="gpu" motherboards={gpus}  updateList={(e)=>setgpu(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />

          </div>
          <div>
            <div className='font-semibold'>Power supply</div>
            <MotherboardCOl init={mbs} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId}  colname="cpu" motherboards={powersupplies}  updateList={(e)=>setPower(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />

          </div>
          <div>
            <div className='font-semibold'>Cases</div>
            <MotherboardCOl init={mbs} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId} colname="cpu" motherboards={cases}  updateList={(e)=>setcase(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
        ...
        setramslot(updatedRamSlot);
            ...
            <MotherboardCOl init={mbs} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId} colname="cpu" motherboards={rams}  updateList={(e)=>{
        ...
        setDiskSlot(updatedDiskSlot);
            ...
            <MotherboardCOl init={mbs} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId} colname="cpu" motherboards={diks}  updateList={(e)=>{
