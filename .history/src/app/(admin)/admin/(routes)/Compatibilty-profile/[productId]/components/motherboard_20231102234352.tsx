...
switch (dayOfWeek) {
  ...
  return (
    <div className='mt-0'>
        ...
        <div className={' mt-1 mx-0  border-1 border-slate-200  dark:border-slate-800 rounded-lg '+(localselectionStaue==true?'bg-slate-100 dark:bg-slate-800':'dark:bg-slate-800 bg-slate-200 bg-opacity-5')}>
