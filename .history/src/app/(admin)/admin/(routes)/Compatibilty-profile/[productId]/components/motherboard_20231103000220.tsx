        ...
        <div className="opacity-0 group-hover:opacity-100 transition absolute w-full px-6 bottom-5">
          <div className="flex gap-x-6 justify-center">
            ...
            />
                        ...
                        <div className='aspect-square object-cover relative'>
                        <Image src={item.images[0].url} width={'100%'} height={50} className='w-full  rounded-b-none aspect-square object-cover' />
                         <div className="opacity-0 group-hover:opacity-100 transition absolute w-full px-6 bottom-5">
                             <div className="flex gap-x-6 justify-center">
                               <IconButton 
