...
const ProductCOl: React.FC<motherboardpar> = ({motherboards}) => {
  ...
  return (
    <div>
        ...
        <div className='m-5 mt-1 mx-0 p-3 border-1 border-slate-200  dark:border-slate-800 rounded-lg grid grid-cols-6 gap-3 col-span-6'>
