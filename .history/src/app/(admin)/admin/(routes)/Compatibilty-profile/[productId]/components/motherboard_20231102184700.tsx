  ...
  return (
    <div>
        ...
        <div className='sm:w-full md:w-96 w-96'>
            ...
            {filteredMotherboards.length>0?         (<>        <div className="rounded-md p-2 m-2 w-max border-slate-300 border-opacity-60  border-1 "><div className='text-sm font-semibold'>Results:</div>{filteredMotherboards.map((prod) => (
          <div className='flex border-1 rounded-sm px-2 my-3  py-3 items-center  hover:bg-slate-50 dark:hover:bg-slate-900 ' key={prod.id}>
