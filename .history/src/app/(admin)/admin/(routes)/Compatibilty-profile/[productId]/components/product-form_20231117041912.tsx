...
const [motherboardId,setLastMotherBoardId]=useState("")
  return (
    <>
      <AlertModal
        isOpen={open}
 ...
 <div>
          ...
          <div>
            ...
            <MotherboardCOl lastMotherBoardId={motherboardId} setLastMotherBoardId={(e)=>setLastMotherBoardId(e.toString())} colname="mb" motherboards={motherboards} updateList={(e)=>setMbs(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
