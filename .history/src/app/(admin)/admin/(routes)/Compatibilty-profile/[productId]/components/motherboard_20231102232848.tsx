...
switch (dayOfWeek) {
  ...
  return (
    <div className='mt-0'>
        ...
        <div className=' mt-1 mx-0 p-3 border-1 border-slate-200  dark:border-slate-800 rounded-lg '>
           
           <div className='mt-1 mx-0 p-3 border-1  rounded-lg grid grid-cols-6 gap-3 col-span-6'>
