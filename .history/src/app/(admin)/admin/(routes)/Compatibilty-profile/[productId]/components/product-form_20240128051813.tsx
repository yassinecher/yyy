...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const [coolings,setCooling]=useState<ProdCol[]>(gpus.filter((e)=>initialData?.coolings.find((ee)=>e.id==ee.productId)))
...
const [motherboardId,setMotherBoardId]=useState("")
 ...
 <div>
          ...
          <div>
            ...
            <MotherboardCOl init={cooling} MotherBoardId={motherboardId} lastMotherBoardId={LastmotherboardId} colname="cooling" motherboards={cooling}  updateList={(e)=>setCooling(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
