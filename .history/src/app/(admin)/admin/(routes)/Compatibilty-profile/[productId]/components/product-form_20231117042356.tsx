...
const [motherboardId,setMotherBoardId]=useState("")
 ...
 <div>
          ...
          <div>
            ...
            <MotherboardCOl  lastMotherBoardId={LastmotherboardId} setLastMotherBoardId={(e)=>setLastMotherBoardId(e.toString())} MotherBoardId={motherboardId} setMotherBoardId={(e)=>setMotherBoardId(e.toString())} colname="mb" motherboards={motherboards} updateList={(e)=>setMbs(e)} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
