...
import { Category, CompatibiltyProfile, Gpu, Harddisk, Image, Memory, Motherboard, PCcase, Powersupply, Processor, Product } from "@prisma/client"
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          <div>
            ...
            <MotherboardCOl colname="mb" motherboards={motherboards} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />

          </div>

          <div>
            <div className='font-semibold'>Processor</div>
            <MotherboardCOl  colname="cpu" motherboards={cpus} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />

          </div>

          <div>
            <div className='font-semibold'>Graphic card</div>
            <MotherboardCOl  colname="cpu" motherboards={gpus} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />

          </div>
          <div>
            <div className='font-semibold'>Power supply</div>
            <MotherboardCOl  colname="cpu" motherboards={powersupplies} selectionStaue={selectionStatu} onSlectionChange={(e)=>setSelectionStatu(e)} />
