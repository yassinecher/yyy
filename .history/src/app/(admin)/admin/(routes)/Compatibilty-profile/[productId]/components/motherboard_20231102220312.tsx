...
<g>
	...
	<circle cx="139" cy="133" r="40.5"/>
            ...
            <div onClick={()=>setOpenDialg(true)}  className='dark:text-slate-100 cursor-pointer min-h-52 min-w-36 bg-slate-100 rounded-lg  text-slate-800  dark:bg-slate-800 justify-center flex align-middle items-center '>
