    ...
    <div className='mt-0'>
           ...
           
        {
           ...
           {motherboardList.map((item)=>{
                return (
                    <><div className={'flex flex-col justify-between   rounded-lg  text-slate-800   dark:text-slate-100 '+(localselectionStaue==true?'bg-slate-100 dark:bg-slate-800':'dark:bg-slate-600 bg-slate-200')}>
