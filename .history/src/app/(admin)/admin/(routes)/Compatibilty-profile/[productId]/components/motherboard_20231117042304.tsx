...
const ProductCOl: React.FC<motherboardpar> = ({colname,motherboards,selectionStaue, onSlectionChange,updateList,MotherBoardId,lastMotherBoardId,setLastMotherBoardId}) => {
