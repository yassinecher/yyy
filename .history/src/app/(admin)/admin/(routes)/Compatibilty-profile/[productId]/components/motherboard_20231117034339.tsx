...
<div className={' mt-1 mx-0  border-1 border-slate-200  dark:border-slate-800 rounded-lg '+(localselectionStaue==true?'bg-white dark:bg-slate-900':'dark:bg-slate-800 bg-slate-200 bg-opacity-5')}>
   ...
   <g>
       ...
       <circle cx="139" cy="133" r="40.5"/>
           ...
           
           {
              ...
              <div className=' p-3 grid grid-cols-12 gap-3 col-span-12'>
              {motherboardList.map((item)=>{
                   return (
   ...
   <div className="aspect-square rounded-xl bg-gray-100 dark:bg-slate-700 p-3 relative">
           <Image 
            src={item.images[0].url} 
             alt="" 
             fill
             className="aspect-square object-cover rounded-md rounded-b-none  p-2 m-1"
           />
           <div className="opacity-0 group-hover:opacity-100  transition absolute w-full px-6 bottom-5">
             <div className="flex gap-x-6 justify-center">
               <IconButton 
