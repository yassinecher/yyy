              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  {i.CathegoryCollectiondata.sort((i)=>i.index).map((lab) => (
                    <div className="grid grid-cols-2 w-96 align-middle" key={lab.index}>
                      <div className="my-auto text-large flex-wrap min-w-max"> {lab&&lab.Label?lab.Label:""}</div>
                      <div>
                      ...
                      col[cIndex-1].index=col[cIndex].index;
                      col[cIndex].index=ccIndex.index
