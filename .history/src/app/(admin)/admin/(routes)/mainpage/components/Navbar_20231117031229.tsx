...
export const Navbar: React.FC<NavbarCollection> = ({
  ...
  const[IsMotherboardCompatiblee,setIsIsMotherboardCompatible]=useState(false)

  console.log(item)
  console.log(NavCollectons)
  return (
    <>
      <div className="mt-10 rounded-large border-1 border-slate-400 bg-slate-50 dark:bg-slate-900 dark:border-slate-700 p-3">
            ...
            <TabsContent value={k.toString()} key={k}>
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="bg-slate-100  dark:bg-slate-900 dark:border-slate-700 my-5 rounded-3xl w-max p-5">
                    ...
                    <div className=" grid grid-cols-2 w-full align-middle" key={lab.index}>
                      <div className=" my-auto mx-4 flex text-large flex-wrap min-w-max ">
                         ...
                         className="hover:text-red-400 mr-3" variant={"ghost"}>
                          <Trash/>
                         </Button>
  ...
  <path id="XMLID_225_" d="M325.607,79.393c-5.857-5.857-15.355-5.858-21.213,0.001l-139.39,139.393L25.607,79.393
    ...
    s7.794-1.581,10.606-4.394l149.996-150C331.465,94.749,331.465,85.251,325.607,79.393z"/>
          ...
          <Dialog data={categories} id={currentDialgId} isMotherboardCompatible={(e)=> setIsIsMotherboardCompatible(e)} ismotherboard={false} handlechange={(i, g) => { handleupdate(i, g) }} onClose={() => { setDialogOpen(false) }} openDialg={dialogOpen} prodList={[]} />
        </Tabs>
        ...
        <Button className="my-3" onClick={() => onSubmit()}>Save changes</Button>
      </div>
    </>
  );
};
