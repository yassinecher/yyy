              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  {i.CathegoryCollectiondata.map((lab, index) => (
                    <div key={index}><Button><svg fill="currentColor" height="40px" width="40px" version="1.1" id="Layer_1" 	 viewBox="0 0 330 330" >
                    <path id="XMLID_224_" d="M325.606,229.393l-150.004-150C172.79,76.58,168.974,75,164.996,75c-3.979,0-7.794,1.581-10.607,4.394
                      ...
                      <div> {lab.Label}</div>
                      <Button>
                      <svg fill="currentColor" height="40px" width="40px" version="1.1" id="Layer_1"  
	 viewBox="0 0 330 330">
