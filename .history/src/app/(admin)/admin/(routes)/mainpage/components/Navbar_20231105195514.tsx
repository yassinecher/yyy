                ...
                <CardContent className="space-y-2">
                  ...
                  {i.CathegoryCollectiondata.map((lab, index) => (
                    <div className="grid grid-cols-2 w-96 align-middle" key={index}>
                      ...
                      <div>
                      {index==0 ?<></>:<Button onClick={()=>{console.log(lab.index)}}  variant={"default"} className="w-16 p-0 bg-slate-600"><svg fill="currentColor" height="20px" width="20px" version="1.1" id="Layer_1" 	 viewBox="0 0 330 330" >
                    <path id="XMLID_224_" d="M325.606,229.393l-150.004-150C172.79,76.58,168.974,75,164.996,75c-3.979,0-7.794,1.581-10.607,4.394
                      ...
                      {index+1==i.CathegoryCollectiondata.length?<></>:
                        <Button onClick={()=>{console.log(lab.index)}} variant={"default"}  className="w-16 p-0 bg-slate-600">
