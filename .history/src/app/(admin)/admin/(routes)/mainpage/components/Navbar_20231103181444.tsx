...
</TabsList>
   {
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <div className="space-y-1">
                <Button onClick={()=>{setDialogOpen(true)}} >add Labels</Button>
             </div>
    ...
    <Dialog data={categories} id={currentDialgId} handlechange={()=>{}} onClose={()=>{setDialogOpen(false)}} openDialg={dialogOpen} prodList={[]}/>
