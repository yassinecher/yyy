              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  {i.CathegoryCollectiondata.map((lab, index) => (
                    <div className="grid grid-cols-2 align-middle" key={index}>{index==0 ?<></>:<Button  variant={"ghost"} className=""><svg fill="currentColor" height="20px" width="20px" version="1.1" id="Layer_1" 	 viewBox="0 0 330 330" >
