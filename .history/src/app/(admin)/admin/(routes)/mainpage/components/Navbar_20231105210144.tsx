    ...
    <>
      <div>
        <div className="pt-10 flex items-center justify-between">
          <div className="flex text-sm">   <Heading  title={header} description="Navbar label for your store" />   <IconButton
                        onClick={() => deletee()}
        ...
        <Input type="text" value={header}  onChange={(e)=>changedd(e.target.value)}/>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  {i.CathegoryCollectiondata.sort((i)=>i.index).map((lab) => (
                    <div className="grid grid-cols-2 w-3/6 align-middle" key={lab.index}>
                    ...
                    <path id="XMLID_224_" d="M325.606,229.393l-150.004-150C172.79,76.58,168.974,75,164.996,75c-3.979,0-7.794,1.581-10.607,4.394
                      ...
                      {lab.index+1==i.CathegoryCollectiondata.length?<></>:
                        <Button onClick={()=>{
                        ...
                        }} variant={"default"}  className="w-16 p-0 bg-slate-600">
