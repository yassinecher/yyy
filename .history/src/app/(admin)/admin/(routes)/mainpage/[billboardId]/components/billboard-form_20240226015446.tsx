...
export const BillboardForm: React.FC<BillboardFormProps> = ({
  ...
  const [colorDesc, setColorDesc] = useColor("#00000"); 
  const [colort, setColort] = useState(""); 
  const [colorDesct, setColorDesct] = useState(""); 
  return (
    <>
    <AlertModal 
      isOpen={open} 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div style={{'color':color.hex??''}} className={`text-[${color.hex}]`}>{form.getValues('title')} </div>
                  </div>
  ...
  <DrawerContent>
    ...
    <ColorPicker  height={228} color={color}  
                   ...
                   onChange={setColor}  /> 
    <DrawerFooter>
    <Button className="w-auto" onClick={()=>setColor({...color,hex:'',hsv:{a:1,h:0,s:0,v:0},rgb:{a:1,b:0,g:0,r:0}})}>Remove Color</Button>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div>
                       ...
                       <div style={{'color':colorDesc.hex??''}} className={`text-[${colorDesc.hex}]`}>{form.getValues('description')} </div>
  ...
  <DrawerContent>
    ...
    <ColorPicker  height={228} color={colorDesc}  
                   ...
                   onChange={(v)=>{setColorDesc(v),setColorDesct(v.hex)}}  /> 
    <DrawerFooter>
    <Button className="w-auto" onClick={()=>setColorDesc({...colorDesc,hex:'',hsv:{a:1,h:0,s:0,v:0},rgb:{a:1,b:0,g:0,r:0}})}>Remove Color</Button>
      <DrawerClose>
        <Button >Close</Button>
      </DrawerClose>
    </DrawerFooter>
