            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div style={{'color':color.hex??''}} className={`text-[${color.hex}] font-bold`}>{form.getValues('title')} </div>
                  </div>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div>
                       ...
                       <div style={{'color':colorDesc.hex??''}} className={`text-[${colorDesc.hex}] font-bold`}>{form.getValues('description')} </div>
