...
export const BillboardForm: React.FC<BillboardFormProps> = ({
  ...
  <DrawerContent>
    ...
    <ColorPicker  height={228} color={color}  
                   ...
                   onChange={setColor}  /> 
    <DrawerFooter>
    <Button className="w-auto" onClick={()=>setColor({...color,hex:'',hsv:{a:0,h:0,s:0,v:1},rgb:{a:0,b:0,g:0,r:1}})}>Remove Color</Button>
  ...
  <DrawerContent>
    ...
    <DrawerFooter>
    <Button className="w-auto" onClick={()=>setColorDesc({...colorDesc,hex:''})}>Remove Color</Button>
      <DrawerClose>
        <Button >Close</Button>
      </DrawerClose>
    </DrawerFooter>
