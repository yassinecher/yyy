...
const formSchema = z.object({
  ...
  PriceColor: z.string().min(0),
  DeletedPrice: z.string().min(0),
  DeletedPriceColor: z.string().min(0),
...
export const BillboardForm: React.FC<BillboardFormProps> = ({
  ...
  const [Pricecolor, setPriceColor] = useColor(form.getValues('PriceColor') || '');
  const [DeletedPricecolor, setDeletedPriceColor] = useColor(form.getValues('DeletedPriceColor') || '');
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><div className="flex">
                    <Input disabled={loading} placeholder="Slide title"
              ...
              <DrawerContent>
                ...
                <DrawerFooter>
                  <Button className="w-auto" onClick={() => {
                    setColor({ ...color, hex: '', hsv: { a: 1, h: 0, s: 0, v: 0 }, rgb: { a: 1, b: 0, g: 0, r: 0 } })
          ...
          <div className="">
            ...
            <Drawer>
              ...
              <DrawerContent>
                ...
                <DrawerFooter>
                  <Button className="w-auto" onClick={() => {
                    setColorDesc({ ...colorDesc, hex: '', hsv: { a: 1, h: 0, s: 0, v: 0 }, rgb: { a: 1, b: 0, g: 0, r: 0 } })
          ...
          <div className="md:grid-cols-3 gap-8">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>PriceColor</FormLabel>
                  <FormControl><div className="flex">
                    <Input disabled={loading} placeholder="PriceColor"
            ...
            />
            <div style={{ 'color': Pricecolor.hex ?? '' }} className={`text-[${Pricecolor.hex}] font-bold ml-2`}>{form.getValues('Price')} </div>

            <Drawer>
              <DrawerTrigger className="w-auto" ><br /><Button type="button" className="w-auto">Color Picker</Button></DrawerTrigger>
              <DrawerContent>
                <DrawerHeader>
                  <DrawerTitle>Pick the Price color: <div style={{ 'color': Pricecolor.hex ?? '' }} className={`text-[${Pricecolor.hex}] `}>{form.getValues('Price')} </div> </DrawerTitle>
                </DrawerHeader>
