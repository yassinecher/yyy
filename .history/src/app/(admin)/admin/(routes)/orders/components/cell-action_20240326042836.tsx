...
export const CellAction: React.FC<CellActionProps> = ({
  ...
  const isPaidString: string = data.isPaid;
const isPaid: boolean = isPaidString.toLowerCase() === 'true'; // Example validation
const archivee: string = data.archivee;
const isarchivee: boolean = archivee.toLowerCase() === 'true'; // Example validation

  const [status, setStatus] = useState<boolean>(isPaid);
  const [archive, setArchive] = useState<boolean>(isarchivee);
