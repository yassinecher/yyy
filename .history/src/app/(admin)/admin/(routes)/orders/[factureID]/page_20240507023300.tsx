    ...
    if (facture && facture.PackOrders) {
        packs = facture.PackOrders.map((p) => {
            return {
                ...
                defaultKeyboard: { ...p.Clavier[0], dicountPrice: parseInt(p.Clavier[0].dicountPrice.toString()), price: parseInt(p.Clavier[0].price.toString()), stock: parseInt(p.Clavier[0].stock.toString()) } as unknown as Product,
                defaultMouse: { ...p.Mouse[0], dicountPrice: parseInt(p.Mouse[0].dicountPrice.toString()), price: parseInt(p.Mouse[0].price.toString()), stock: parseInt(p.Mouse[0].stock.toString()) } as unknown as Product,
                defaultMousePad: { ...p.MousePad[0], dicountPrice: parseInt(p.MousePad[0].dicountPrice.toString()), price: parseInt(p.MousePad[0].price.toString()), stock: parseInt(p.MousePad[0].stock.toString()) } as unknown as Product,
                defaultMics: { ...p.Mic[0], dicountPrice: parseInt(p.Mic[0].dicountPrice.toString()), price: parseInt(p.Mic[0].price.toString()), stock: parseInt(p.Mic[0].stock.toString()) } as unknown as Product,
                defaultHeadset:{...p.Headset[0],dicountPrice:parseInt(p.Headset[0].dicountPrice.toString()),price:parseInt(p.Headset[0].price.toString()),stock:parseInt(p.Headset[0].stock.toString())}as unknown as Product,
                defaultCamera: {...p.Camera[0],dicountPrice:parseInt(p.Camera[0].dicountPrice.toString()),price:parseInt(p.Camera[0].price.toString()),stock:parseInt(p.Camera[0].stock.toString())}as unknown as Product,
                defaultScreen: {...p.Screen[0],dicountPrice:parseInt(p.Screen[0].dicountPrice.toString()),price:parseInt(p.Screen[0].price.toString()),stock:parseInt(p.Screen[0].stock.toString())}as unknown as Product,
                DefaultSpeaker: {...p.Speaker[0],dicountPrice:parseInt(p.Speaker[0].dicountPrice.toString()),price:parseInt(p.Speaker[0].price.toString()),stock:parseInt(p.Speaker[0].stock.toString())}as unknown as Product,
                DefaultManette: {...p.Manette[0],dicountPrice:parseInt(p.Manette[0].dicountPrice.toString()),price:parseInt(p.Manette[0].price.toString()),stock:parseInt(p.Manette[0].stock.toString())}as unknown as Product,
                DefaultChair: {...p.Chair[0],dicountPrice:parseInt(p.Chair[0].dicountPrice.toString()),price:parseInt(p.Chair[0].price.toString()),stock:parseInt(p.Chair[0].stock.toString())}as unknown as Product,
                number: 1
            }
        })
        console.log(packs[0])
