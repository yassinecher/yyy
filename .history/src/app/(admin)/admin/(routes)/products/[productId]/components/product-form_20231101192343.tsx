...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const [parentInputArray, setParentInputArray] = useState<Array<{ name: string; value: string }>>(defaultValues.additionalDetails);
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <InputArray onInputArrayChange={handleInputArrayChange} inputArrayp={initialData?.additionalDetails??[]} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
