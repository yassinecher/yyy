            ...
            render={({ field }) => (
              <FormItem>
                ...
                <InputArray onInputArrayChange={handleInputArrayChange}
                  ...
                  onChange={(url: any) => field.onChange([...field.value, { name: url.name, value: url.value }])}
                  inputArrayp={field.value.map((i) => ({ name: i.name, value: i.value }))} onRemove={function (value: string): void {
