...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const [parentInputArray, setParentInputArray] = useState<Array<{ name: string; value: string }>>( (initialData?.additionalDetails || []).map((item) => ({
    name: item.name,
    value: item.value
  })),
  );
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <InputArray onInputArrayChange={handleInputArrayChange} inputArrayp={parentInputArray} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
