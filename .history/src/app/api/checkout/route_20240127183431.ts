...
export async function POST(
  ...
  try {
    ...
    const pcOrderItems= pc.map((productId) => ({
      ...
      const pcOrderCreateInput = {
        id: "your_unique_id", // Use your own logic to generate a unique ID
        price: "your_price_value", // Replace with the actual price value
        motorderItemId: "your_motherboard_order_item_id", // Replace with the actual motherboard OrderItem ID
        proorderItemId: "your_processor_order_item_id", // Replace with the actual processor OrderItem ID
        gpuorderItemId: "your_gpu_order_item_id", // Replace with the actual GPU OrderItem ID
        ramorderItemId: ["ram_order_item_id_1", "ram_order_item_id_2"], // Replace with the actual RAM OrderItem IDs
        disorderItemId: "your_disk_order_item_id", // Replace with the actual disk OrderItem ID
        di2orderItemId: "your_disk2_order_item_id", // Replace with the actual disk2 OrderItem ID
        poworderItemId: "your_power_order_item_id", // Replace with the actual power OrderItem ID
        casorderItemId: "your_case_order_item_id", // Replace with the actual case OrderItem ID
        scrorderItemId: "your_screen_order_item_id", // Replace with the actual screen OrderItem ID
        cooorderItemId: "your_cooling_order_item_id", // Replace with the actual cooling OrderItem ID
      
        // Connect to existing OrderItem records with the specified IDs
        motherboard: {
          connect: { id: "your_motherboard_order_item_id" },
        },
        processor: {
          connect: { id: "your_processor_order_item_id" },
        },
        gpu: {
          connect: { id: "your_gpu_order_item_id" },
        },
        ram: {
          connect: [
            { id: "ram_order_item_id_1" },
            { id: "ram_order_item_id_2" },
            // Add more as needed
          ],
        },
        disk: {
          connect: { id: "your_disk_order_item_id" },
        },
        disk2: {
          connect: { id: "your_disk2_order_item_id" },
        },
        power: {
          connect: { id: "your_power_order_item_id" },
        },
        case: {
          connect: { id: "your_case_order_item_id" },
        },
        screen: {
          connect: { id: "your_screen_order_item_id" },
        },
        cooling: {
          connect: { id: "your_cooling_order_item_id" },
        },
      };
      
      // Use the Prisma client to create the pcOrder record with connections
      const createdPcOrder = await prismadb.pcOrder.create({
        data: pcOrderCreateInput,
      });
      
      console.log("Created pcOrder:", createdPcOrder);
