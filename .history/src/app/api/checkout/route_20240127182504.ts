        ...
        data: {
          ...
          orderPc: {
            create: {
                ...
                case:{
                    connect:{
                        id:pcOrderItems[0].motorderItemId
                    }
                },
                motorderItemId:" pcOrderItems[0]",
                proorderItemId:" pcOrderItems[0]",
                gpuorderItemId:" pcOrderItems[0]",
                ramorderItemId:[" pcOrderItems[0]"] ,// Assuming ram is an array, adjust as needed
                disorderItemId:" pcOrderItems[0]",
                poworderItemId:" pcOrderItems[0]",
                casorderItemId:" pcOrderItems[0]",
                scrorderItemId:" pcOrderItems[0]", // Assuming screen is optional
                cooorderItemId:" pcOrderItems[0]", // Assuming cooling is optional
