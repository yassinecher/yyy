...
export async function GET(req: Request, res: NextApiResponse) {
  try {
    const { searchParams } = new URL(req.url || '', 'http://localhost'); // Use a base URL, replace with your actual base URL
    ...
    // Include additional logic for handling filterList if needed
