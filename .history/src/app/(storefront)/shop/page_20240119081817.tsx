...
import { motherboardFilters } from './_componenets/Filters'
...
<Sidebar header={header}   filter={lfilters} isloadingg={false} categories={categorie} title={search.toString()}  items={formattedproducts}  />
