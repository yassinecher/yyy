...
console.log(prods.findIndex((e)=>e.motherboard))
  ...
  if(prods.length>0){
    const total=prods[0]._count
  }
  return (
    <div className=' dark:bg-[#000000e6] bg-[#ffffffe6] my-10 container rounded-lg'>
       

<Sidebar total={prods} header={header} category={categoryy.toString()}  filter={filters} isloadingg={false} categories={categorie} title={search.toString()}  items={formattedproducts}  />
