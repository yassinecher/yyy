...
export type HomeFilter={
 ...
 const Home = async ({
  ...
  if (search) {
    whereClause.AND = wordList.map((word) => ({
      name: {
        contains: word,
        mode: 'insensitive',
      },
...
<Sidebar totalprod={totalprod} header={header} category={categoryy.toString()}  filter={filters} isloadingg={false} categories={categorie} titlee={search.toString()}  items={formattedproducts}  />
