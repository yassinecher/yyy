...
import { addCaseFitlters, addCoolingFitlters, addHardDiskFitlters, addLaptopFitlters, addPowerFitlters, addRamFitlters, addScreenFitlters, addcpuFitlters, addgpuitlters, addmotherboardFitlters } from './_componenets/FilterFunctions'
...
const Home = async ({
  ...
  if (filterListParam.length > 0) {
    ...
    if (decodedFilterList.data) {
      ...
      if (typee == "laptop") {
        whereClause.laptops = addLaptopFitlters(fList).data
