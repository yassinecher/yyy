...
const Sidebar: React.FC<ProductListProps> = ({
  ...
  const fetchData=(cate?:string,sort?:string)=>{
    ...
    setTitle("")
    setTimeTaken(0)
    router.push(`/shop?minDt=${priceFilter[0]}&maxDt=${priceFilter[1]}&search=${searchTerm}&categorie=${cate}&sort=${sort}`)
    router.refresh()
  }
  return (
          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 dark:border-gray-800 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="cursor-pointer absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white dark:bg-black  shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                          ...
                          {({ active }) => (
                            <a
                              ...
                              className={classNames(
                                option.current ? 'font-medium text-gray-900 dark:text-gray-100 dark:text-gray-100' : 'text-gray-500',
                                active ? 'bg-gray-500' : '',
