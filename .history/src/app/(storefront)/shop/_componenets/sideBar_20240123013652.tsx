      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 dark:border-gray-800 pb-6 pt-24">
            ...
            <br /><span className='font-light text-sm underline cursor-pointer' onClick={()=>{router.push("/shop");router.refresh()}}> Tous Les produits {"> "} </span><span className='font-light text-sm '>{header}</span>
