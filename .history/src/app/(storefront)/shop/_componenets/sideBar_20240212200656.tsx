      ...
      {props.items.map((item) => (
        <div key={item.name}>
          <div className='flex items-center appearance-none'>
            <Input type='checkbox' className='appearance-none forced-colors checked:bg-violet-700 border-violet-500 focus:border-violet-500 hover:focus:border-violet-500   focus:outline-none focus-visible:outline-none w-3 h-3 m-2 outline-none'
              value={item.name}
