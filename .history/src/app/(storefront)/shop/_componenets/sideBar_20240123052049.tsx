        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment}>
          <Dialog as="div" className="relative z-50 lg:hidden" onClose={setMobileFiltersOpen}>
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 bg-black z-50 dark:bg-black  bg-opacity-50" />
            </Transition.Child>
            ...
            <div className="fixed inset-0 z-50 flex">
              ...
              >
                <Dialog.Panel className=" relative ml-0 flex h-full w-full  max-w-lg flex-col overflow-y-auto bg-white bg-opacity-25 dark:bg-black  py-4 pb-12 shadow-xl">
