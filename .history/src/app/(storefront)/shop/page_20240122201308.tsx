...
console.log(prods.findIndex((e)=>e.motherboard))
  ...
  let totalprod=0
  if(prods.length>0){
    totalprod=prods[0]._count.category
  }
  return (
    <div className=' dark:bg-[#000000e6] bg-[#ffffffe6] my-10 container rounded-lg'>
       

<Sidebar totalprod={totalprod} header={header} category={categoryy.toString()}  filter={filters} isloadingg={false} categories={categorie} title={search.toString()}  items={formattedproducts}  />
