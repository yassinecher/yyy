                ...
                <PopoverContent className="w-80 dark:bg-black mr-7 mb-0">
                    <div className="grid gap-4">
                        <div className="space-y-2">
                            ...
                            <p className="">
                            <div className="font-medium leading-none">Mon PC</div><div className='text-sm text-muted-foreground'> sur mesure, c'est un outil parfait, conçu exactement pour moi ! </div>
                            </p>
                        </div>
