...
export const BuildForm = (props: {
    ...
    const setMC=(val :string,etat:boolean)=>{
        const newc={...allProductCompatibility.Compatibility,motherboardCompatibility:{
            message: val,
            error: etat,
        }}
        setAllProductCompatibility({Compatibility:newc})
    }
    const setPC=(val :string,etat:boolean)=>{
        const newc={...allProductCompatibility.Compatibility,processorCompatibility:{
            message: val,
            error: etat,
        }}
        setAllProductCompatibility({Compatibility:newc})
    }
    const setCC=(val :string,etat:boolean)=>{
        const newc={...allProductCompatibility.Compatibility,caseCompatibility:{
            message: val,
            error: etat,
        }}
        setAllProductCompatibility({Compatibility:newc})
    }
    const setRC=(val :string,etat:boolean)=>{
        const newc={...allProductCompatibility.Compatibility,ramCompatibility:{
            message: val,
            error: etat,
        }}
        setAllProductCompatibility({Compatibility:newc})
    }
    const setHC=(val :string,etat:boolean)=>{
        const newc={...allProductCompatibility.Compatibility,hardDiskCompatibility:{
            message: val,
            error: etat,
        }}
        setAllProductCompatibility({Compatibility:newc})
    }
    const setPSC=(val :string,etat:boolean)=>{
        const newc={...allProductCompatibility.Compatibility,powerCompatibility:{
            message: val,
            error: etat,
        }}
        setAllProductCompatibility({Compatibility:newc})
        ...
        if (motherboardId) {
            ...
            if (processorId) {
                ...
                if (haveCommonElement(MProfiles, PProfiles)) {
                  ...
                  setMC('Compatible',false)
                  setPC('Compatible',false)
                } else {
                    setMC('Non Compatible',true)
                    setPC('Non Compatible',true)
                }
    ...
    return (
        <div>
            ...
            <Ram
                ...
                setAllProductCompatibility={setAllProductCompatibility}
