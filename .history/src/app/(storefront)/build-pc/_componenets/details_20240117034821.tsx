    ...
    return (
        <div>
            ...
            <Popover >
                ...
                <PopoverContent className=" dark:bg-black mr-7 mb-0 w-screen sm:min-w-screen md:min-w-screen">
                    ...
                    <div className='w-full mt-3 flex justify-end'>
                        ...
                        <Button variant={'outline'} className='bg-transparent'>Ajouter au panier <Shopcard/></Button> <Button>Commander</Button> 
