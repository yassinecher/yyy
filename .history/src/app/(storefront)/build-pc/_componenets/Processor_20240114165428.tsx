    ...
    <div>
            ...
            <CardContent>
              <div className='flex flex-col md:flex-row lg:flex-col'>
                <button onClick={()=>steOpenDialog(true)} className='w-[20%] min-md:max-lg:w-full  m-3 bg-transparent border-transparent hover:bg-transparent hover:border-transparent '>
                  <Card className="   ">
                    <CardHeader>
