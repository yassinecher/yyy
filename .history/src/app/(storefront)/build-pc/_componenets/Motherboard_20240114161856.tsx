                ...
                {props.motherboardId ? <>
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group  rounded-xl space-x-3">
                    ...
                    <div className="flex-grow  p-3">
                      ...
                      <p className="text-sm text-gray-500 overflow-hidden text-ellipsis">{props.motherboardId.description}</p>
                    </div>
                         {/* Compatiblité */}
                      ...
                      <div className=' text-left grid grid-cols-3 text-xs my-3 w-max '>
                       ...
                       <div className={props.selectedCompatibility.motherboardCompatibility.processorCompatibility.error?'text-red-600 ':'text-green-600 '}>Processeur compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.processorCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.processorCompatibility.message}</div>

                       <div className={props.selectedCompatibility.motherboardCompatibility.ramCompatibility.error?'text-red-600 ':'text-green-600 '}>Ram compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.ramCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.ramCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.motherboardCompatibility.hardDiskCompatibility.error?'text-red-600 ':'text-green-600 '}>Disque dur compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.hardDiskCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.hardDiskCompatibility.message}</div>

                       <div className={props.selectedCompatibility.motherboardCompatibility.powerCompatibility.error?'text-red-600 ':'text-green-600 '}>Boite d'alimentation compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.powerCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.powerCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.motherboardCompatibility.caseCompatibility.error?'text-red-600 ':'text-green-600 '}>Boitier compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.caseCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.caseCompatibility.message}</div>
