...
export const Motherboard = (props: {
  ...
  {/* Price & Review */}
  <div className="flex-shrink-0 text-xs text-center flex flex-col justify-center ">
  <div className='p-3 '>
  <Currency  value={props.motherboardId?.price} />
  </div>
   <a href="zz" target='_blank'>
   <Button>Voir en store</Button>
   </a>
                              ...
                              <div onClick={()=>steOpenDialog(!openDialog)} className='color-[#f59e0b] w-full h-full flex justify-center items-center'>
