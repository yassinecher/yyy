...
const Number = async () => {
    try {
      ...
      if (dataa.number === 2) {
        props.setRams((prevRamschoisi: Array<Memory | undefined>) => {
            const updatedArray = [undefined,undefined];
// Assuming you want to set the next element to undefined
            return updatedArray;
          });
          for(let t=0;t<2;t++){
            updateElementAtIndex(t,undefined)
            console.log("ee")
          }
        let n = 0;
        let i=0
        ...
        props.setRams((prevRamschoisi: Array<Memory | undefined>) => {
            const updatedArray = [undefined,undefined,undefined,undefined];
// Assuming you want to set the next element to undefined
            return updatedArray;
          });
        for(let t=0;t<4;t++){
