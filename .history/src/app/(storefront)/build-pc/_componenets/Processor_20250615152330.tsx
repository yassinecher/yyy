...
import { extractCoreCount, extractPerformanceCoreClock, SelectedFeatures } from './BuildForm'
...
export const Processor = (props: {
  ...
  const [searchTime, setSearchTime] = useState(0);
      ...
      const [recommendedcpuclock,setRecommendedcpuclock]= useState();
       const [recommendedcpuclockgh,setRecommendedcpuclockgh]= useState();
  const sortOptions = [
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                      {data.map((item, key) => (
                        ...
                        <div key={key} className="dark:bg-[#321642d0] bg-[#ffffffe6] flex flex-col justify-between group cursor-pointer rounded-xl border p-3 space-y-1">
                          ...
                          <div>
                                                   <div>
              {extractCoreCount(item.description) === recommendedcpuclock&&extractPerformanceCoreClock(item.description) === recommendedcpuclockgh && recommendedcpuclockgh !== null&&recommendedcpuclock!==null && (
