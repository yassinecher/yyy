                  ...
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group  rounded-xl space-x-3">
                    ...
                    <div className="flex-shrink-0  p-3">
                     ...
                     {props.selectedCompatibility?<>
                      <div className="flex-shrink-0">
                      <div className=' text-left grid grid-cols-3 text-xs py-3 border-l h-full '>
                       ...
                       <div  className={`col-span-2 ${props.caseCompatibility.processorCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.caseCompatibility.message}</div>
