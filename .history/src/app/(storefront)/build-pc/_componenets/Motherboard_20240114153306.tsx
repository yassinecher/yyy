                  ...
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group  rounded-xl space-x-3">
                    ...
                    {props.selectedCompatibility?<>
                      ...
                      <div className=' text-left grid grid-cols-3 text-xs   '>
                       <div className={props.selectedCompatibility.motherboardCompatibility.error?'text-red-600 ':'text-green-600 '}>Carte mére compatibilité </div><div className='col-span-2'> : {props.selectedCompatibility.motherboardCompatibility.message}</div>
                       <div>Processeur compatibilité </div><div  className='col-span-2'> : {props.selectedCompatibility.processorCompatibility.message}</div>
