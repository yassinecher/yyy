                     ...
                     if(motherboardId){
                        ...
                        if(haveCommonElement(MProfiles,PProfiles)){
                              if(hardDiskSecondaire){
                                const MProfiless = props.profiles.filter((e) => e.motherboards.find((ee) => ee.productId == motherboardId.id))
                                if(haveCommonElement(MProfiles,MProfiless)){
                                    updates['hardDiskCompatibility'] = { message: 'Compatible', error: false };
                                }else{
                                    updates['hardDiskCompatibility'] = { message: 'Stockage Secondaire Non Compatible', error: false };
                                }
                      }else{
                        updates['hardDiskCompatibility'] = { message: 'Compatible', error: false };
