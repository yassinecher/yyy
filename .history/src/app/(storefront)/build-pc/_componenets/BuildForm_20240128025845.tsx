...
export const BuildForm = (props: {
    ...
    const setCompatibility = (type: string, value: string, error: boolean) => {
      ...
      useEffect(() => {
        if (motherboardId) {
          ...
          if (processorId) {
            ...
            if (haveCommonElement(MProfiles, PProfiles)) {
              setCompatibility('motherboard', 'zzCompatible', false);
              setCompatibility('processor', 'Compatible', false);
            } else {
              setCompatibility('motherboard', 'Non zzCompatible', true);
              setCompatibility('processor', 'Non Compatible', true);
            }
          }
        }
        ...
        if (processorId) {
          ...
          if (motherboardId) {
            ...
            if (haveCommonElement(MProfiles, PProfiles)) {
              setCompatibility('motherboard', 'Compatible', false);
              setCompatibility('processor', 'Compatible', false);
            } else {
              setCompatibility('motherboard', 'Non Compatible', true);
              setCompatibility('processor', 'Non Compatible', true);
            }
          }
        }
