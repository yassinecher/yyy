            ...
            <Popover >
                ...
                <PopoverContent className="w-80 dark:bg-black mr-7 mb-0">
                    <div className="grid gap-4">
                        ...
                        <div>
  <div style={{ fontWeight: 'bold', fontSize: 'md', display: 'inline-block' }}>Mon PC</div>
  <div className='text-sm' style={{ display: 'inline-block' }}> sur mesure, c'est un outil parfait, conçu exactement pour moi !</div>
</div>
