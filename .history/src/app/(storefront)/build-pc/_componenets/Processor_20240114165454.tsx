    ...
    <div>
            ...
            <CardContent>
              <div className='flex flex-col md:flex-row lg:flex-col'>
                <button onClick={()=>steOpenDialog(true)} className='  m-3 bg-transparent border-transparent hover:bg-transparent hover:border-transparent '>
                  <Card className=" w-[20%] min-md:max-lg:w-full  ">
                    <CardHeader>
        ...
        {props.processorId.description.length > 100 && (
          <span className=" font-bold cursor-pointer" onClick={toggleDescription}>
            {showFullDescription ? ' See Less' : ' See More'}
                      ...
                      <div className="">
                      <div className=' text-left grid grid-cols-3 text-xs my-3 w-max '>
                      
                       <div className={props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error?'text-red-600 ':'text-green-600 '}>Carte mére compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.motherboardCompatibility.message}</div>

                       <div className={props.selectedCompatibility.processorCompatibility.ramCompatibility.error?'text-red-600 ':'text-green-600 '}>Ram compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.ramCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.ramCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.error?'text-red-600 ':'text-green-600 '}>Disque dur compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.message}</div>

                       <div className={props.selectedCompatibility.processorCompatibility.powerCompatibility.error?'text-red-600 ':'text-green-600 '}>Boite d'alimentation compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.powerCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.powerCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.processorCompatibility.caseCompatibility.error?'text-red-600 ':'text-green-600 '}>Boitier compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.caseCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.caseCompatibility.message}</div>
