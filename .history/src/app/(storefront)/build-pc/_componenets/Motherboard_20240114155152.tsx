...
import { AllProductsCompatibility } from './BuildForm'
type checkItem = {
  id: number,
  searchKey: string
}
                ...
                {props.motherboardId ? <>
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group  rounded-xl space-x-3">
                    ...
                    <div className=" p-3">
                      ...
                      <div className="">
                      <div className=' text-left grid grid-cols-3 text-xs my-3 w-96 '>
                       <div className={props.selectedCompatibility.motherboardCompatibility.error?'text-red-600 ':'text-green-600 '}>Carte mére compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.processorCompatibility.error?'text-red-600 ':'text-green-600 '}>Processeur compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.message}</div>

                       <div className={props.selectedCompatibility.ramCompatibility.error?'text-red-600 ':'text-green-600 '}>Ram compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.ramCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.ramCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.hardDiskCompatibility.error?'text-red-600 ':'text-green-600 '}>Disque dur compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.hardDiskCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.hardDiskCompatibility.message}</div>

                       <div className={props.selectedCompatibility.powerCompatibility.error?'text-red-600 ':'text-green-600 '}>Boite d'alimentation compatibilité </div>
                       <div className={`col-span-2 ${props.selectedCompatibility.powerCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.powerCompatibility.message}</div>
                       
                       <div className={props.selectedCompatibility.caseCompatibility.error?'text-red-600 ':'text-green-600 '}>Boitier compatibilité </div>
                       <div  className={`col-span-2 ${props.selectedCompatibility.caseCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.caseCompatibility.message}</div>
                    ...
                    <div className=" p-3">
                      <div className=' text-center flex flex-col   '>
                        <div className='p-3 w-36 text-sm '>
