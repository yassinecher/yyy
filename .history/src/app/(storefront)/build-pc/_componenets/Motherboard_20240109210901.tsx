...
export const Motherboard = (props:{motherboardmanufacturer:Filter}) => {
           ...
           <div>
            {
              props.motherboardmanufacturer.list.map((ee)=>(
                ...
                <Input type='checkbox' className=' forced-colors  focus:outline-none focus-visible:outline-none w-3 h-3 m-2 outline-none'   />
                <div>
                {ee}
                </div>
