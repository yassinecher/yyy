    ...
    return (
        <div>
            ...
            <Popover >
                ...
                <PopoverContent className="w-auto dark:bg-black mr-7 mb-0">
                    <div className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Card>
                                <CardContent className='p-0 flex align-middle justify-around '>
                                    <div className=' p-2 text-sm font-semibold'>
                                    Carte mére
                                    </div>
                                   {props.motherboardId?<>
                                    <div className='text-sm p-2  border-x-1'>
                                    { props.motherboardId.name}
                                   </div>
                                   <div className='text-sm p-2'>
                                    { props.motherboardId.price} (TND)
                                   </div>
                                   </>:<>
                            ...
                            <Card>
                                <CardContent className='p-0  flex align-middle justify-around '>
                                   ...
                                   {props.ramId.findIndex((e)=>e!=null)!=-1?<>
                                   {
                                    props.ramId.map((item)=>(
                                        <>
                                              {item?<>
                                                ...
                                                <div>
                                   <div className='text-sm p-2 h-full border-x-1'>
                                    { item.name+' '} 
                                    <span className='font-semibold ml-1'> {' '+ item.price} (TND)</span>
                                   </div>
...
const Btn = () => {
    return (<>
        ...
        ><div className='bg-amber-500 text-white  fixed border rounded-full p-1 w-6 h-6 translate-x-10 -translate-y-3 text-xs'>?</div><svg version="1.0"
