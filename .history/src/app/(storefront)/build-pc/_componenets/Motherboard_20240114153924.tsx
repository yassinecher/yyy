                    ...
                    <div className="flex-shrink-0  p-3">
                     ...
                     {props.selectedCompatibility?<>
                      ...
                      <div className=' text-left grid grid-cols-3 text-xs py-3 border-l h-full '>
                       <div className={props.selectedCompatibility.motherboardCompatibility.error?'text-red-600 ':'text-green-600 '}>Carte mére compatibilité </div><div className={`col-span-2 ${props.selectedCompatibility.motherboardCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.motherboardCompatibility.message}</div>
                       <div className={props.selectedCompatibility.processorCompatibility.error?'text-red-600 ':'text-green-600 '}>Processeur compatibilité </div><div  className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.error?' text-red-600 ':' text-green-600 '}`  }> : {props.selectedCompatibility.processorCompatibility.message}</div>
