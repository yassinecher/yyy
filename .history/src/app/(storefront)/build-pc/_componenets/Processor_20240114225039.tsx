...
export const Processor = (props: {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`/api/processor/component?minDt=${priceFilter[0]}&maxDt=${priceFilter[1]}&q=${searchTerm}&sort=${selectedSort}&units=10&page=${currentPage}&filterList=${encodedFilterList}`);
