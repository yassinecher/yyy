...
export const Motherboard = (props:{
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.patch(`/api/motherboard/component?page=${currentPage}`, {
        filterList: filterList || {}, // Ensure filterList is defined or provide a default value
      });
