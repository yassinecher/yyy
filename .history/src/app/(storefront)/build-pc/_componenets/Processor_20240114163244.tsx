...
export const Processor = (props: {
  ...
  <div className="flex-grow  p-3">
    ...
    <p className="text-sm text-gray-500">{props.processorId.description}</p>
  </div>
                       {/* Compatiblité */}
                      ...
                      <div className=' text-left grid grid-cols-3 text-xs my-3 w-max '>
                       ...
                       <div className={props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error?'text-red-600 ':'text-green-600 '}>Processeur compatibilité </div>
