...
export const Motherboard = (props: {
            ...
            <CardContent>
              <div className='flex flex-col md:flex-row'>
                ...
                <Card className="md:w-[80%]  justify-center flex align-middle items-center m-3 cursor-pointer ">
                  ...
                  {props.motherboardId?<>
                      <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group cursor-pointer rounded-xl w-full p-3 space-x-3">
  {/* Image & actions */}
  <div className="flex-shrink-0 w-1/5 h-"> {/* Set an appropriate width for your design */}
    <div className="aspect-square rounded-xl bg-gray-100 dark:bg-transparent relative" style={{ paddingBottom: '100%' }}>
      <Image
  ...
  <div className="flex-grow">
    ...
    <p className="text-sm text-gray-500">{props.motherboardId.category?.name}</p>
  </div>
  {/* Price & Review */}
  <div className="flex-shrink-0 text-xs">
    <Currency value={props.motherboardId?.price} />
                              ...
                              <div className='color-[#f59e0b] w-full flex justify-center'>
