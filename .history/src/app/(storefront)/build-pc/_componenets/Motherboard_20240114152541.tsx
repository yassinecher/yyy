                  ...
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group  rounded-xl space-x-3">
                    ...
                    {props.selectedCompatibility?<>
                      ...
                      <div className=' text-center flex flex-col text-xs   '>
                       <div>Carte mére compatibilité :{props.selectedCompatibility.motherboardCompatibility.message}</div>
                       <div>Processeur compatibilité : {props.selectedCompatibility.processorCompatibility.message}</div>
