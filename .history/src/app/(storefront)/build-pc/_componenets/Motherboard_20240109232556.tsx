...
export const Motherboard = (props:{
  ...
  motherboardmanufacturer:Filter, motherboardramslots:Filter}) => {
      ...
      <Dialog>
        ...
        <DialogContent  className='min-w-full min-h-[80%] flex flex-col' >
          ...
          <div className='grid grid-cols-6 gap-3 h-[70vh]' >
           ...
           <div>
            {
              props.motherboardmanufacturer.list.map((ee)=>(
                ...
                <Input type='checkbox' className='appearance-none focus:outline-red-500 forced-colors  focus:outline-none focus-visible:outline-none w-3 h-3 m-2 outline-none'   />
                <div>
                {ee.name} ({ee.number})
                </div>
           ...
           <div>
            {
              props.motherboardramslots.list.map((ee)=>(
                <>
           ...
           <div>
            {
              props.motherboardformat.list.map((ee)=>(
               ...
               <Button className=' my-3 pl-10 mx-auto absolute bottom-0' onClick={()=>{
