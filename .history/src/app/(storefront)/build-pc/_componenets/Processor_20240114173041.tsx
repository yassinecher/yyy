                  ...
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group items-center rounded-xl space-x-3">
                    ...
                    <div className="flex-shrink-0  p-3">
                      ...
                      <div className="">
                        ...
                        <div className="text-left w-2/5 grid  text-sm max-w-screen-md mx-auto border border-gray-300 rounded mb-3 mr-3">
  <div className="p-1 border-b border-r border-gray-300">
