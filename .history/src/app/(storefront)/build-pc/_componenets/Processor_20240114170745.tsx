          ...
          <div className='flex lg:flex-row flex-col '>
            ...
            <Card className="lg:w-4/5 w-full min-w-md:max-w-lg justify-center flex align-middle items-center m-3">
              <CardContent className='p-0 w-full h-full'>
                ...
                {props.processorId ? <>
                  <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-row justify-between group align-middle rounded-xl space-x-3">
                    {/* Image & actions */}
                    ...
                    {props.selectedCompatibility ? <>
                      <div className="">
                        <div className="text-left grid grid-cols-3 text-xs my-3 w-96 mx-auto">
                          <div className={` ${props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            Carte mère compatibilité
                          </div>
                          <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            : {props.selectedCompatibility.processorCompatibility.motherboardCompatibility.message}
                          </div>

                          <div className={` ${props.selectedCompatibility.processorCompatibility.ramCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            Ram compatibilité
                          </div>
                          <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.ramCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            : {props.selectedCompatibility.processorCompatibility.ramCompatibility.message}
                          </div>

                          <div className={` ${props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            Disque dur compatibilité
                          </div>
                          <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            : {props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.message}
                          </div>

                          <div className={` ${props.selectedCompatibility.processorCompatibility.powerCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            Boîte d'alimentation compatibilité
                          </div>
                          <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.powerCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            : {props.selectedCompatibility.processorCompatibility.powerCompatibility.message}
                          </div>

                          <div className={` ${props.selectedCompatibility.processorCompatibility.caseCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
                            Boîtier compatibilité
                          </div>
                          <div className={`col-span-2 ${props.selectedCompatibility.processorCompatibility.caseCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
