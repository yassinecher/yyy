...
type YourComponentProps = {
    ...
    setRams:(values: Array<Memory | undefined>) => void ;
...
export const Ram: React.FC<YourComponentProps> = (props: {
    ...
    const addEmptyCase = () => {
      ...
      const updateCase = (index: number, item: Memory | undefined) => {
        props.setRams(prevRams => {
            const updatedArray = [...prevRams];
            updatedArray[index] = item;
            return updatedArray;
          });
        console.log('Before Update:', props.rams);
      ...
      const remove2caseProduct = (index: number) => {
        const updatedArray = [...props.rams];
        updatedArray[index] = undefined;
        updatedArray[updatedArray.length - 1] = undefined; // Assuming you want to set the last element to undefined
        props.setRams([...updatedArray]);
      };
