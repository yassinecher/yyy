          ...
          <Card className="m-3  ">
            <CardContent>
              <div className=' sm:flex'>
                <button className='w-[20%] sm:w-[100%]  m-3 bg-transparent border-transparent hover:bg-transparent hover:border-transparent '>
                  <Card className="   ">
                    <CardHeader>
                ...
                <Card className="w-[80%]  justify-center flex align-middle items-center m-3 cursor-pointer ">
