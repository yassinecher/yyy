...
export const Ram: React.FC<YourComponentProps> = (props: {
    ...
    const [ramId, setRamId] = useState<Array<Memory | undefined>>(props.rams)
    const addEmptyCase = () => {
        setRamId((prevRams: (Memory | undefined)[]) => [
          ...prevRams,
          undefined
        ]);
      };
      ...
      const updateCase = (index: number, item: Memory | undefined) => {
        setRamId((prevRams: Array<Memory | undefined>) => {
          const updatedArray = [...prevRams];
      ...
      const remove2CaseProduct = (index: number) => {
        ...
        setRamId((prevRams: (Memory | undefined)[]) => updatedArray);
      };
...
useEffect(()=>{
    ...
    useEffect(() => {
        ...
        if (ramSlotNumber === 2) {
          ...
          setRamId([undefined, undefined, undefined, undefined]);
