                ...
                <Card className="md:w-[80%]  justify-center flex align-middle items-center m-3 cursor-pointer ">
                  <CardContent className='p-0 '>
                    ...
                    {props.motherboardId?<>
                      ...
                      <div className="dark:bg-[#000000e6] bg-[#ffffffe6] h-full flex flex-col justify-between group cursor-pointer rounded-xl p-3 space-y-1">
                          {/* Image & actions */}
                          <div className=' h-full'>
                            <div className="h-full aspect-square rounded-xl  bg-gray-100 dark:bg-transparent relative">
                              <Image
