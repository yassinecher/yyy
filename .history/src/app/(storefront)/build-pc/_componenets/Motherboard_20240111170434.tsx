...
export const Motherboard = (props:{
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await axios.patch(`/api/motherboard/component?page=${currentPage}`, { filterList });

      // Update your state or handle the response data as needed
      setData(response.data);     setData(response.data.results);
