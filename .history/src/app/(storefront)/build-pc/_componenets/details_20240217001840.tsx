...
<><li className='font-semibold text-red-500'>*{e.message}</li></>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction>Fermer</AlertDialogAction>
            ...
            <Popover >
                <PopoverTrigger className='absolute   bottom-0 right-0 z-50 mr-7 mb-7' asChild>
...
const Btn = () => {
    return (<>
        ...
        ><div className='bg-purple-500 text-white  fixed border rounded-full p-1 w-6 h-6 translate-x-10 -translate-y-3 text-xs'>?</div><svg version="1.0"
