      ...
      <Dialog>
        <DialogTrigger asChild>
          <Card className="m-3  ">
            <CardContent>
              <div className='flex'>
                <button className='w-[20%] m-3 bg-transparent border-transparent hover:bg-transparent hover:border-transparent '>
                  <Card className="   ">
                    <CardHeader>
                ...
                <Card className="w-[70%]  justify-center flex align-middle items-center m-3 cursor-pointer ">
