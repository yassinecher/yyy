        ...
        {props.processorId.description.length > 100 && (
          <span className=" font-bold cursor-pointer" onClick={toggleDescription}>
            {showFullDescription ? ' See Less' : ' See More'}
                      ...
                      <div className="">
                      <div className="text-left grid grid-cols-3 text-xs w-max">
  <div className={`mb-3 pr-3 ${props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    Carte mère compatibilité
  </div>
  <div className={`col-span-2 mb-3 ${props.selectedCompatibility.processorCompatibility.motherboardCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    : {props.selectedCompatibility.processorCompatibility.motherboardCompatibility.message}
  </div>

  <div className={`mb-3 pr-3 ${props.selectedCompatibility.processorCompatibility.ramCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    Ram compatibilité
  </div>
  <div className={`col-span-2 mb-3 ${props.selectedCompatibility.processorCompatibility.ramCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    : {props.selectedCompatibility.processorCompatibility.ramCompatibility.message}
  </div>

  <div className={`mb-3 pr-3 ${props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    Disque dur compatibilité
  </div>
  <div className={`col-span-2 mb-3 ${props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    : {props.selectedCompatibility.processorCompatibility.hardDiskCompatibility.message}
  </div>

  <div className={`mb-3 pr-3 ${props.selectedCompatibility.processorCompatibility.powerCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    Boîte d'alimentation compatibilité
  </div>
  <div className={`col-span-2 mb-3 ${props.selectedCompatibility.processorCompatibility.powerCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    : {props.selectedCompatibility.processorCompatibility.powerCompatibility.message}
  </div>

  <div className={`mb-3 pr-3 ${props.selectedCompatibility.processorCompatibility.caseCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
    Boîtier compatibilité
  </div>
  <div className={`col-span-2 mb-3 ${props.selectedCompatibility.processorCompatibility.caseCompatibility.error ? 'text-red-600' : 'text-green-600'}`}>
