            ...
            <Popover >
                ...
                <PopoverContent className=" dark:bg-black mr-7 mb-0 w-screen  lg:w-auto md:w-auto">
                    ...
                    <div className='w-full mt-3 flex justify-end'>
                        ...
                        <Button variant={'outline'} className='bg-transparent'onClick={sendTocart} >Ajouter au panier <Shopcard/></Button> <Button>Commander</Button> 
