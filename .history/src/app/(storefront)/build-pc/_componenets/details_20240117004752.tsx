        ...
        <div>
            ...
            <Popover >
                <PopoverTrigger asChild>
                    ...
                    <div  className='dark:color-[#f59e0b] shadow-md dark:bg-black drop-shadow hover:shadow-inner  bg-amber-50 rounded-full p-3 border '
                    ><svg version="1.0"
...
-2 4207 -3 0 -2675z"/>
                ...
                <PopoverContent className="w-80 mr-7 mb-0">
