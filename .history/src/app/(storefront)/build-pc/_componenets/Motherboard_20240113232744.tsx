                ...
                <Card className="md:w-[80%]  justify-center flex align-middle items-center m-3 cursor-pointer ">
                  <CardContent className='p-0 '>
                    ...
                    {props.motherboardId?<>
                      ...
                      <div className="dark:bg-[#000000e6] bg-[#ffffffe6] flex flex-col justify-between group cursor-pointer rounded-xl border p-3 space-y-1">
                          {/* Image & actions */}
                          <div className='flex'>
                            <div className="aspect-square rounded-xl h-full bg-gray-100 dark:bg-transparent relative">
                              <Image
