  ...
  return ( 
    <li className="flex py-6 border-b">
      <Card className="w-full">
        ...
        <div className="relative h-10 w-10 rounded-md overflow-hidden sm:h-48 sm:w-48">
        <Image
          fill
      ...
      <div className="relative ml-4 flex flex-1 flex-col justify-between sm:ml-6">
        ...
        <CardContent className="p-0">
          {seeMore?<>  <div className="relative h-24 w-24 rounded-md overflow-hidden sm:h-48 sm:w-48">
        <Image
          fill
          src={data.case.images[0].url}
          alt=""
