  ...
  return (
    <div>
      <Dialog>
        ...
        <DialogContent className="relative lg:min-w-[80%] h-full overflow-y-auto max-h-full md:max-h-screen  min-w-[100%]   ">
          <div className='h-d max-h-full md:max-h-screen overflow-y-scroll '>
