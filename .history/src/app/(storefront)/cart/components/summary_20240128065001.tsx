...
const Summary = () => {
  ...
  return ( 
    <div
      className="mt-16 rounded-lg dark:bg-black bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8"
    >
      <h2 className="text-lg font-medium text-gray-900 dark:text-white">
        Order summary
      </h2>
      <div className="mt-6 space-y-4">
        <div className="flex items-center justify-between border-t dark:border-gray-900 border-gray-200 pt-4">
