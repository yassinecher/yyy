    ...
    <div>
      <Dialog onOpenChange={()=>{setisDone(false)}}>
        <DialogTrigger asChild >
          <Button disabled={data.length === 0} className="w-full mt-6 dark:bg-purple-500 bg-purple-500  hover:bg-purple-500 font-semibold text-lg dark:text-white">Passer à la caisse</Button>
        </DialogTrigger>
