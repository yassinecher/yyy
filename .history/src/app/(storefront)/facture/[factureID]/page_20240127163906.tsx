...
return {
    ...
    motherboard:e.motherboard[0].product as unknown as Product,
    processor: e.processor[0].product as unknown as Product,
    gpu: e.gpu[0].product as unknown as Product,
    ram: e.ram as unknown[] as Product[],
    disk: e.disk[0].product as unknown as Product,
    disk2: e.disk[1].product as unknown as Product,
    power: e.power[0].product as unknown as Product,
    case: e.case[0].product as unknown as Product,
    screen: e.screen[0].product as unknown as Product,
    cooling: e.cooling[0].product as unknown as Product,
    number:1
}
