      ...
      const getpcs: () => Promise<CartItem[]>= async () =>{
        const pcsz =  await Promise.all((facture?.orderPc || []).map(async (e) => {
            ...
            return {
                ...
                disk2:{...disk2,price:parseInt(disk2.price.toString()),stock:parseInt(disk2.stock.toString())},
                ...
                screen:{...screen,price:parseInt(screen.price.toString()),stock:parseInt(screen.stock.toString())},
                cooling:{...cooling,price:parseInt(cooling.price.toString()),stock:parseInt(cooling.stock.toString())},
                number:1
            }
