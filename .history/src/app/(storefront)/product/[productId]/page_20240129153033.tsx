...
if(prod.storages.length>0){
  ...
  return (
    ...
    <Image src={'/images/remise.png'} className="dark:invisible absolute  z-20 -mr-3 -mt-3 rotate-[25deg] ml-auto" alt="" width={100} height={100} />
    <Image src={'/images/remise-dark.png'} className="dark:visible absolute  z-20 -mr-3 -mt-3 rotate-[25deg] ml-auto" alt="" width={100} height={100} />
