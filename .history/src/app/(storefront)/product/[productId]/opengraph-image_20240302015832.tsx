...
export default async function og({ params }: Props) {
  ...
  return new ImageResponse(
    (
      <div tw="bg-Violet-600 relative flex items-center justify-center">
        ...
        <div tw="w-[150px]  flex items-start absolute ml-3  top-0 left-0">
        <img tw="w-[120px]" src="https://gaminggear.tn/images/logo%20(3).png" alt={prod?.name}  /> 
