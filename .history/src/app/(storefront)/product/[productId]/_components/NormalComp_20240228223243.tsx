...
const NormalComp: React.FC<nProps> = ({item}) => {
  return (
    <div>            <><div className='flex cursor-pointer flex-col justify-between  bg-slate-100 rounded-lg  text-slate-800  dark:bg-slate-800 dark:text-slate-100'>
