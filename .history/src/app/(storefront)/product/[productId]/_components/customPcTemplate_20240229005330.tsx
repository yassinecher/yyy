        ...
        <div>  <div className="lg:grid lg:grid-cols-3 lg:items-start lg:gap-x-8">
            ...
            <div className="mt-10 md:mx-0 sm:mx-0 lg:mx-20 col-span-2 sm:mt-16 sm:px-0 lg:mt-0">
                <div>
                    ...
                    <div className="mt-10  mb-4 flex items-center gap-x-3">
                        <Button variant={"default"}   onClick={onAddToCart} className="flex items-center bg-purple-500 text-white hover:bg-purple-500 focbg-purple-500  gap-x-2">
                           Ajouter au panier
            ...
            <div className='grid  grid-cols-2 md:grid-cols-5 gap-2'>
                ...
                <div className='border p-3 rounded-lg mb-3 border-purple-500 w-full'>
                    <div className='flex flex-col h-full justify-between'>
                        ...
                        <NormalComp item={cpu} motherboards={cpus} setItem={setcpu} />
                ...
                <div className='border p-3 rounded-lg mb-3 border-purple-500 w-full'>
                    <div className='flex flex-col h-full justify-between'>
                        ...
                        <NormalComp item={gpu} motherboards={gpus} setItem={setgpu} />
                ...
                <div className='border p-3 rounded-lg mb-3 border-purple-500 w-full'>
                    <div className='flex flex-col h-full justify-between'>
                        ...
                        <NormalComp item={power} motherboards={powersupplies} setItem={setPower} />
