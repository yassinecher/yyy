...
<Image src={'/images/remise-dark.png'} className="invisible dark:visible absolute  z-20 -mr-6 rotate-[25deg] ml-auto" alt="" width={100} height={100} />
 ...
 <TableBody>
      ...
      <div className="mt-10 flex items-center gap-x-3">
        <Button onClick={onAddToCart} className="flex items-center gap-x-2">
          ...
          <ShoppingCart size={20} />
  ...
  </div><Motherboardd selectedCompatibility={undefined} setMotherboardId={function (values: Product | undefined): void {
                            throw new Error('Function not implemented.');
                        } } motherboardId={undefined} profiles={[]} motherboardmanufacturer={{
                            title: "undefined",
                            list: []
                        }} motherboardchipset={{
                            title: "undefined",
                            ...
                            title: "undefined",
                            list: []
                        }} cpuId={undefined} motherboardramslots={{
                            title: "undefined",
                            list: []
                        }}   />
