...
powersupplies?: Power[];
rams?: RAM[];
setItem:(r:RAM|undefined,key:number)=>void
keyy:number
}


const NormalComp: React.FC<nProps> = ({item, setItem,motherboards, gpus, cpus, cases, powersupplies, cooling, diks, rams,keyy }) => {
  ...
  <SheetContent >
    <SheetHeader>
     ...
     {rams?<>
       ...
       Vous Ne pouvez pas changer cet Produit
       </>:<>
       <div className=''>
    ...
    {   mot.products[0].price.toString()} TND <br />
            ...
            <Button variant={'outline'} onClick={()=>{setItem(mot,key);setOpen(false)}}>Selectionner</Button>
