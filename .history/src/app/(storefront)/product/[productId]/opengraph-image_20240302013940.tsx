...
export default async function og({ params }: Props) {
  ...
  return new ImageResponse(
    (
      <div tw="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 relative flex items-center justify-center">
        ...
        <div  tw=" flex flex-col w-[600px] ">
            ...
            <p tw="text-black text-md flex font-bold m-5">{prod?.description}</p>
        </div>
      </div>
    ),
    size
