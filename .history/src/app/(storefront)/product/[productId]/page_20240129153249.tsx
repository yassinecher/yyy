...
if(prod.storages.length>0){
  ...
  return (
    ...
    <Image src={'/images/remise.png'} className="dark:hidden absolute  z-20 -mr-6 rotate-[25deg] ml-auto" alt="" width={100} height={100} />
    <Image src={'/images/remise-dark.png'} className="dark:flex absolute  z-20 -mr-6 rotate-[25deg] ml-auto" alt="" width={100} height={100} />
