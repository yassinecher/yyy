...
console.log(initialData)
  ...
  const onSubmit = async (data: ProductFormValues) => {
    ...
    try {
      ...
      if (initialData) {
        await axios.patch(`/api/peripherique/Manette/component/${params.productId}`, data);
      } else {
        await axios.post(`/api/peripherique/Manette/component`, data);
      }
      router.refresh();
      router.push(`/admin/Manette`);
